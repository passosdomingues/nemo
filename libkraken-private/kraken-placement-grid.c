...
KrakenPlacementGrid *
kraken_placement_grid_new (KrakenIconContainer *container, gboolean tight)
{
    ...
    grid = g_new0 (KrakenPlacementGrid, 1);
...
void
kraken_placement_grid_free (KrakenPlacementGrid *grid)
{
...
gboolean
kraken_placement_grid_position_is_free (KrakenPlacementGrid *grid, EelIRect pos)
{
    int x, y;
...
void
kraken_placement_grid_mark (KrakenPlacementGrid *grid, EelIRect pos)
{
    int x, y;
...
void
kraken_placement_grid_canvas_position_to_grid_position (KrakenPlacementGrid *grid,
                                                      ...
                                                      EelIRect *grid_position)
{
     ...
     * during a snap. */
    KrakenIconContainer *container = grid->container;
...
void
kraken_placement_grid_mark_icon (KrakenPlacementGrid *grid, KrakenIcon *icon)
{
    EelIRect icon_pos;
    EelIRect grid_pos;
    
    kraken_icon_container_icon_get_bounding_box (grid->container, icon,
    ...
    kraken_placement_grid_mark (grid, grid_pos);
}
