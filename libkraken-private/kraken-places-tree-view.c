...
#include "kraken-places-tree-view.h"

G_DEFINE_TYPE (KrakenPlacesTreeView, kraken_places_tree_view,
               GTK_TYPE_TREE_VIEW);

static void     kraken_places_tree_view_finalize (GObject *gobject);

static gpointer parent_class;

static void
kraken_places_tree_view_init (KrakenPlacesTreeView *tree_view)
{
    gtk_style_context_add_class (gtk_widget_get_style_context (GTK_WIDGET (tree_view)), "places-treeview");
}

static void
kraken_places_tree_view_class_init (KrakenPlacesTreeViewClass *klass)
{
	GtkWidgetClass *widget_class = GTK_WIDGET_CLASS (klass);
    GObjectClass         *object_class = G_OBJECT_CLASS(klass);
    parent_class           = g_type_class_peek_parent (klass);
    object_class->finalize = kraken_places_tree_view_finalize;
...
GtkWidget *
kraken_places_tree_view_new (void)
{
    return g_object_new (KRAKEN_TYPE_PLACES_TREE_VIEW, NULL);
}

static void
kraken_places_tree_view_finalize (GObject *object)
{
