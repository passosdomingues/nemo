...
#ifndef KRAKEN_SIGNALLER_H
#define KRAKEN_SIGNALLER_H

#include <glib-object.h>

/* KrakenSignaller is a class that manages signals between
   disconnected Kraken code. Kraken objects connect to these signals
...
/* Get the one and only KrakenSignaller to connect with or emit signals for */
GObject *kraken_signaller_get_current (void);

#endif /* KRAKEN_SIGNALLER_H */
