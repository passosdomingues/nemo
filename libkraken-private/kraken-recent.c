...
kraken_recent_get_manager (void)
{
...
void
kraken_recent_add_file (KrakenFile *file,
			  GAppInfo *application)
{
	...
	recent_data.mime_type = kraken_file_get_mime_type (file);
	...
	gtk_recent_manager_add_full (kraken_recent_get_manager (),
				     uri, &recent_data);
