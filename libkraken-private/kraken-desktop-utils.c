...
void
kraken_desktop_utils_get_monitor_work_rect (gint num, GdkRectangle *rect)
{
#if GTK_CHECK_VERSION (3, 22, 0)
    ensure_display ();
...
void
kraken_desktop_utils_get_monitor_geometry (gint num, GdkRectangle *rect)
{
#if GTK_CHECK_VERSION (3, 22, 0)
    ensure_display ();
    g_return_if_fail (num >= 0 && num < gdk_display_get_n_monitors (default_display));
...
gint
kraken_desktop_utils_get_primary_monitor (void)
{
#if GTK_CHECK_VERSION (3, 22, 0)
    gint n_mon, i;
...
gint
kraken_desktop_utils_get_monitor_for_widget (GtkWidget *widget)
{
    GdkWindow *window;
    GtkWidget *toplevel;
    gint monitor;
...
gint
kraken_desktop_utils_get_num_monitors (void)
{
    ensure_screen ();
...
gboolean
kraken_desktop_utils_get_monitor_cloned (gint monitor, gint x_primary)
{
...
gint
kraken_desktop_utils_get_scale_factor (void)
{
    guint scale;
