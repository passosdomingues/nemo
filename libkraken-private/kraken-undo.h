...
/* kraken-undo.h - public interface for objects that implement
...
#ifndef KRAKEN_UNDO_H
#define KRAKEN_UNDO_H

#include <glib-object.h>

typedef struct _KrakenUndoTransaction KrakenUndoTransaction;


/* The basic undoable operation. */
typedef void (* KrakenUndoCallback) (GObject *target, gpointer callback_data);
...
void kraken_undo_register              (GObject              *target,
					  KrakenUndoCallback  callback,
					  gpointer              callback_data,
					  GDestroyNotify        callback_data_destroy_notify,
...
void kraken_undo_register_full         (GList                *atoms,
					  ...
					  const char           *redo_menu_item_label,
					  const char           *redo_menu_item_hint);
void kraken_undo_unregister            (GObject              *target);
 ...
 */
void kraken_undo                       (GObject              *undo_manager_search_start_object);

/* Connecting an undo manager. */
void kraken_undo_share_undo_manager    (GObject              *destination_object,
