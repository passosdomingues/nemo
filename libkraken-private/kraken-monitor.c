/* -*- Mode: C; indent-tabs-mode: t; c-basic-offset: 8; tab-width: 8 -*-
   ...
   kraken-monitor.c: file and directory change monitoring for kraken
	     ...
	     gpointer user_data)
{
	...
	case G_FILE_MONITOR_EVENT_CHANGES_DONE_HINT:
		kraken_file_changes_queue_file_changed (child);
		break;
	case G_FILE_MONITOR_EVENT_DELETED:
		kraken_file_changes_queue_file_removed (child);
		break;
	case G_FILE_MONITOR_EVENT_CREATED:
		kraken_file_changes_queue_file_added (child);
		break;
...
KrakenMonitor *
kraken_monitor_directory (GFile *location)
{
	GFileMonitor *dir_monitor;
	KrakenMonitor *ret;

    ret = g_new0 (KrakenMonitor, 1);
...
void
kraken_monitor_cancel (KrakenMonitor *monitor)
{
