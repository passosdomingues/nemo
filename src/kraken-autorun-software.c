...
present_autorun_for_software_dialog (GMount *mount)
{
	...
	icon_size = kraken_get_icon_size_for_stock_size (GTK_ICON_SIZE_DIALOG);
	icon_info = kraken_icon_info_lookup (icon, icon_size,
                                       gtk_widget_get_scale_factor (GTK_WIDGET (dialog)));
	pixbuf = kraken_icon_info_get_pixbuf_at_size (icon_info, icon_size);
