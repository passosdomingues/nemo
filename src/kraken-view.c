...
#include "kraken-properties-window.h"
...
#include <libkraken-private/kraken-file-private.h>
...
#include <libkraken-private/kraken-recent.h>
...
#include <libkraken-private/kraken-file-undo-manager.h>
#include <libkraken-private/kraken-action.h>
#include <libkraken-private/kraken-widget-action.h>
#include <libkraken-private/kraken-separator-action.h>
#include <libkraken-private/kraken-action-manager.h>
#include <libkraken-private/kraken-mime-application-chooser.h>

#define DEBUG_FLAG KRAKEN_DEBUG_DIRECTORY_VIEW
...
#define KRAKEN_VIEW_MENU_PATH_OPEN_PLACEHOLDER                  "/MenuBar/File/Open Placeholder"
#define KRAKEN_VIEW_MENU_PATH_APPLICATIONS_SUBMENU_PLACEHOLDER  "/MenuBar/File/Open Placeholder/Open With/Applications Placeholder"
#define KRAKEN_VIEW_MENU_PATH_APPLICATIONS_PLACEHOLDER    	  "/MenuBar/File/Open Placeholder/Applications Placeholder"
#define KRAKEN_VIEW_MENU_PATH_SCRIPTS_PLACEHOLDER               "/MenuBar/File/Open Placeholder/Scripts/Scripts Placeholder"
#define KRAKEN_VIEW_MENU_PATH_ACTIONS_PLACEHOLDER               "/MenuBar/File/Open Placeholder/ActionsPlaceholder"
#define KRAKEN_VIEW_MENU_PATH_EXTENSION_ACTIONS_PLACEHOLDER     "/MenuBar/Edit/Extension Actions"
#define KRAKEN_VIEW_MENU_PATH_NEW_DOCUMENTS_PLACEHOLDER  	  "/MenuBar/File/New Items Placeholder/New Documents/New Documents Placeholder"
#define KRAKEN_VIEW_MENU_PATH_OPEN				  "/MenuBar/File/Open Placeholder/Open"

#define KRAKEN_VIEW_POPUP_PATH_SELECTION            "/selection"
#define KRAKEN_VIEW_POPUP_PATH_OPEN_PLACEHOLDER	  "/selection/Open Placeholder"
#define KRAKEN_VIEW_POPUP_PATH_APPLICATIONS_SUBMENU_PLACEHOLDER "/selection/Open Placeholder/Open With/Applications Placeholder"
#define KRAKEN_VIEW_POPUP_PATH_APPLICATIONS_PLACEHOLDER    	  "/selection/Open Placeholder/Applications Placeholder"
#define KRAKEN_VIEW_POPUP_PATH_SCRIPTS_PLACEHOLDER    	  "/selection/Open Placeholder/Scripts/Scripts Placeholder"
#define KRAKEN_VIEW_POPUP_PATH_ACTIONS_PLACEHOLDER           "/selection/Open Placeholder/ActionsPlaceholder"
#define KRAKEN_VIEW_POPUP_PATH_EXTENSION_ACTIONS		  "/selection/Extension Actions"
#define KRAKEN_VIEW_POPUP_PATH_OPEN				  "/selection/Open Placeholder/Open"

#define KRAKEN_VIEW_POPUP_PATH_BACKGROUND			  "/background"
#define KRAKEN_VIEW_POPUP_PATH_BACKGROUND_SCRIPTS_PLACEHOLDER	  "/background/Before Zoom Items/New Object Items/Scripts/Scripts Placeholder"
#define KRAKEN_VIEW_POPUP_PATH_BACKGROUND_ACTIONS_PLACEHOLDER   "/background/Before Zoom Items/New Object Items/ActionsPlaceholder"
#define KRAKEN_VIEW_POPUP_PATH_BACKGROUND_NEW_DOCUMENTS_PLACEHOLDER "/background/Before Zoom Items/New Object Items/New Documents/New Documents Placeholder"

#define KRAKEN_VIEW_POPUP_PATH_LOCATION			  "/location"

#define KRAKEN_VIEW_POPUP_PATH_BOOKMARK_MOVETO_ENTRIES_PLACEHOLDER "/selection/File Actions/MoveToMenu/BookmarkMoveToPlaceHolder"
#define KRAKEN_VIEW_POPUP_PATH_BOOKMARK_COPYTO_ENTRIES_PLACEHOLDER "/selection/File Actions/CopyToMenu/BookmarkCopyToPlaceHolder"
#define KRAKEN_VIEW_MENU_PATH_BOOKMARK_MOVETO_ENTRIES_PLACEHOLDER "/MenuBar/Edit/File Items Placeholder/MoveToMenu/BookmarkMoveToPlaceHolder"
#define KRAKEN_VIEW_MENU_PATH_BOOKMARK_COPYTO_ENTRIES_PLACEHOLDER "/MenuBar/Edit/File Items Placeholder/CopyToMenu/BookmarkCopyToPlaceHolder"

#define KRAKEN_VIEW_POPUP_PATH_PLACES_MOVETO_ENTRIES_PLACEHOLDER "/selection/File Actions/MoveToMenu/PlacesMoveToPlaceHolder"
#define KRAKEN_VIEW_POPUP_PATH_PLACES_COPYTO_ENTRIES_PLACEHOLDER "/selection/File Actions/CopyToMenu/PlacesCopyToPlaceHolder"
#define KRAKEN_VIEW_MENU_PATH_PLACES_MOVETO_ENTRIES_PLACEHOLDER "/MenuBar/Edit/File Items Placeholder/MoveToMenu/PlacesMoveToPlaceHolder"
#define KRAKEN_VIEW_MENU_PATH_PLACES_COPYTO_ENTRIES_PLACEHOLDER "/MenuBar/Edit/File Items Placeholder/CopyToMenu/PlacesCopyToPlaceHolder"
...
struct KrakenViewDetails
{
	KrakenWindow *window;
	KrakenWindowSlot *slot;
	KrakenDirectory *model;
	KrakenFile *directory_as_file;
	KrakenFile *location_popup_directory_as_file;
	KrakenBookmarkList *bookmarks;
    ...
    KrakenActionManager *action_manager;
	 ...
	 * This flag should need not be set inside subclasses. KrakenView automatically
...
static void     kraken_view_duplicate_selection              (KrakenView      *view,
							        GList                *files,
							        GArray               *item_locations);
static void     kraken_view_create_links_for_files           (KrakenView      *view,
							        GList                *files,
							        GArray               *item_locations);
static void     trash_or_delete_files                          (GtkWindow            *parent_window,
								...
								KrakenView      *view);
static void     load_directory                                 (KrakenView      *view,
								KrakenDirectory    *directory);
static void     kraken_view_merge_menus                      (KrakenView      *view);
static void     kraken_view_unmerge_menus                    (KrakenView      *view);
static void     kraken_view_init_show_hidden_files           (KrakenView      *view);
static void     clipboard_changed_callback                     (KrakenClipboardMonitor *monitor,
								KrakenView      *view);
static void     open_one_in_new_window                         (gpointer              data,
								gpointer              callback_data);
static void     schedule_update_menus                          (KrakenView      *view);
static void     schedule_update_menus_callback                 (gpointer              callback_data);
static void     remove_update_menus_timeout_callback           (KrakenView      *view);
static void     schedule_update_status                          (KrakenView      *view);
static void     remove_update_status_idle_callback             (KrakenView *view);
static void     reset_update_interval                          (KrakenView      *view);
static void     schedule_idle_display_of_pending_files         (KrakenView      *view);
static void     unschedule_display_of_pending_files            (KrakenView      *view);
static void     disconnect_model_handlers                      (KrakenView      *view);
static void     metadata_for_directory_as_file_ready_callback  (KrakenFile         *file,
								gpointer              callback_data);
static void     metadata_for_files_in_directory_ready_callback (KrakenDirectory    *directory,
								GList                *files,
								gpointer              callback_data);
static void     kraken_view_trash_state_changed_callback     (KrakenTrashMonitor *trash,
							        gboolean              state,
							        gpointer              callback_data);
static void     kraken_view_select_file                      (KrakenView      *view,
							        KrakenFile         *file);

static void     update_templates_directory                     (KrakenView *view);
static void     user_dirs_changed                              (KrakenView *view);

static gboolean file_list_all_are_folders                      (GList *file_list);

static void unschedule_pop_up_location_context_menu (KrakenView *view);
static void disconnect_bookmark_signals (KrakenView *view);
static void run_action_callback (KrakenAction *action, gpointer callback_data);
static void update_accelerated_actions (KrakenView *view);

G_DEFINE_TYPE (KrakenView, kraken_view, GTK_TYPE_SCROLLED_WINDOW);
#define parent_class kraken_view_parent_class

/* virtual methods (public and non-public) */

/**
 * kraken_view_merge_menus:
 *
 * Add this view's menus to the window's menu bar.
 * @view: KrakenView in question.
 */
static void
kraken_view_merge_menus (KrakenView *view)
{
	g_return_if_fail (KRAKEN_IS_VIEW (view));

	KRAKEN_VIEW_CLASS (G_OBJECT_GET_CLASS (view))->merge_menus (view);
}

static void
kraken_view_unmerge_menus (KrakenView *view)
{
	g_return_if_fail (KRAKEN_IS_VIEW (view));

	KRAKEN_VIEW_CLASS (G_OBJECT_GET_CLASS (view))->unmerge_menus (view);}

static char *
real_get_backing_uri (KrakenView *view)
{
	KrakenDirectory *directory;
	char *uri;

	g_return_val_if_fail (KRAKEN_IS_VIEW (view), NULL);
	...
	if (KRAKEN_IS_DESKTOP_DIRECTORY (directory)) {
		directory = kraken_desktop_directory_get_real_directory (KRAKEN_DESKTOP_DIRECTORY (directory));
	} else {
...
char *
kraken_view_get_backing_uri (KrakenView *view)
{
	g_return_val_if_fail (KRAKEN_IS_VIEW (view), NULL);

	return KRAKEN_VIEW_CLASS (G_OBJECT_GET_CLASS (view))->get_backing_uri (view);
}

/**
 * kraken_view_select_all:
 *
 * select all the items in the view
 *
 **/
static void
kraken_view_select_all (KrakenView *view)
{
	g_return_if_fail (KRAKEN_IS_VIEW (view));

	KRAKEN_VIEW_CLASS (G_OBJECT_GET_CLASS (view))->select_all (view);
}

static void
kraken_view_call_set_selection (KrakenView *view, GList *selection)
{
	g_return_if_fail (KRAKEN_IS_VIEW (view));

	KRAKEN_VIEW_CLASS (G_OBJECT_GET_CLASS (view))->set_selection (view, selection);
}

static GList *
kraken_view_get_selection_for_file_transfer (KrakenView *view)
{
	g_return_val_if_fail (KRAKEN_IS_VIEW (view), NULL);

	return KRAKEN_VIEW_CLASS (G_OBJECT_GET_CLASS (view))->get_selection_for_file_transfer (view);
}

/**
 * kraken_view_get_selected_icon_locations:
 *
 ...
 **/
static GArray *
kraken_view_get_selected_icon_locations (KrakenView *view)
{
	g_return_val_if_fail (KRAKEN_IS_VIEW (view), NULL);

	return KRAKEN_VIEW_CLASS (G_OBJECT_GET_CLASS (view))->get_selected_icon_locations (view);
}

static void
kraken_view_invert_selection (KrakenView *view)
{
	g_return_if_fail (KRAKEN_IS_VIEW (view));

	KRAKEN_VIEW_CLASS (G_OBJECT_GET_CLASS (view))->invert_selection (view);
}

/**
 * kraken_view_reveal_selection:
 *
 * Scroll as necessary to reveal the selected items.
 **/
static void
kraken_view_reveal_selection (KrakenView *view)
{
	g_return_if_fail (KRAKEN_IS_VIEW (view));

	KRAKEN_VIEW_CLASS (G_OBJECT_GET_CLASS (view))->reveal_selection (view);
}

/**
 * kraken_view_reset_to_defaults:
 *
 * set sorting order, zoom level, etc. to match defaults
 *
 **/
static void
kraken_view_reset_to_defaults (KrakenView *view)
{
    KrakenFile *file;
    KrakenWindow *window;
    g_return_if_fail (KRAKEN_IS_VIEW (view));

    KRAKEN_VIEW_CLASS (G_OBJECT_GET_CLASS (view))->reset_to_defaults (view);
    ...
    if (show_hidden) {
        kraken_window_set_hidden_files_mode (window, KRAKEN_WINDOW_SHOW_HIDDEN_FILES_ENABLE);
    } else {
        kraken_window_set_hidden_files_mode (window, KRAKEN_WINDOW_SHOW_HIDDEN_FILES_DISABLE);
    }

    file = view->details->slot->viewed_file;
    kraken_file_set_metadata(file, KRAKEN_METADATA_KEY_SHOW_THUMBNAILS, NULL, NULL);
    kraken_file_set_metadata(file, KRAKEN_METADATA_KEY_DEFAULT_VIEW, NULL, NULL);
    gtk_action_activate (gtk_action_group_get_action (kraken_window_get_main_action_group (window), KRAKEN_ACTION_RELOAD));
}

static gboolean
kraken_view_using_manual_layout (KrakenView  *view)
{
	g_return_val_if_fail (KRAKEN_IS_VIEW (view), FALSE);

	return 	KRAKEN_VIEW_CLASS (G_OBJECT_GET_CLASS (view))->using_manual_layout (view);
}

static guint
kraken_view_get_item_count (KrakenView *view)
{
	g_return_val_if_fail (KRAKEN_IS_VIEW (view), 0);

	return 	KRAKEN_VIEW_CLASS (G_OBJECT_GET_CLASS (view))->get_item_count (view);
}

/**
 * kraken_view_can_rename_file
 *
 ...
 **/
static gboolean
kraken_view_can_rename_file (KrakenView *view, KrakenFile *file)
{
	return 	KRAKEN_VIEW_CLASS (G_OBJECT_GET_CLASS (view))->can_rename_file (view, file);
}

static gboolean
kraken_view_is_read_only (KrakenView *view)
{
	g_return_val_if_fail (KRAKEN_IS_VIEW (view), FALSE);

	return 	KRAKEN_VIEW_CLASS (G_OBJECT_GET_CLASS (view))->is_read_only (view);
}

static gboolean
showing_trash_directory (KrakenView *view)
{
	KrakenFile *file;

	file = kraken_view_get_directory_as_file (view);
	if (file != NULL) {
		return kraken_file_is_in_trash (file);
	}
	return FALSE;
}

static gboolean
showing_recent_directory (KrakenView *view)
{
   KrakenFile *file;

   file = kraken_view_get_directory_as_file (view);
   if (file != NULL) {
       return kraken_file_is_in_recent (file);
   }
   return FALSE;
}

static gboolean
showing_favorites_directory (KrakenView *view)
{
   KrakenFile *file;

   file = kraken_view_get_directory_as_file (view);
   if (file != NULL) {
       return kraken_file_is_in_favorites (file);
   }
   return FALSE;
}

static gboolean
showing_admin_enabled_directory (KrakenView *view)
{
    KrakenFile *file;
    ...
    if (file != NULL) {
        return kraken_file_has_uri_scheme (file, "admin");
    }
...
static gboolean
kraken_view_supports_creating_files (KrakenView *view)
{
	g_return_val_if_fail (KRAKEN_IS_VIEW (view), FALSE);

    return !kraken_view_is_read_only (view)
...
static gboolean
kraken_view_is_empty (KrakenView *view)
{
	g_return_val_if_fail (KRAKEN_IS_VIEW (view), FALSE);

	return 	KRAKEN_VIEW_CLASS (G_OBJECT_GET_CLASS (view))->is_empty (view);
}

/**
 * kraken_view_bump_zoom_level:
 *
 * bump the current zoom level by invoking the relevant subclass through the slot
 *
 **/
void
kraken_view_bump_zoom_level (KrakenView *view,
			       int zoom_increment)
{
	g_return_if_fail (KRAKEN_IS_VIEW (view));

	if (!kraken_view_supports_zooming (view)) {
		return;
	}

	KRAKEN_VIEW_CLASS (G_OBJECT_GET_CLASS (view))->bump_zoom_level (view, zoom_increment);
}
 ...
 **/
void
kraken_view_zoom_to_level (KrakenView *view,
			     KrakenZoomLevel zoom_level)
{
	...
	KRAKEN_VIEW_CLASS (G_OBJECT_GET_CLASS (view))->zoom_to_level (view, zoom_level);
}

KrakenZoomLevel
kraken_view_get_zoom_level (KrakenView *view)
{
	g_return_val_if_fail (KRAKEN_IS_VIEW (view), KRAKEN_ZOOM_LEVEL_STANDARD);

	if (!kraken_view_supports_zooming (view)) {
		return KRAKEN_ZOOM_LEVEL_STANDARD;
	}

	return KRAKEN_VIEW_CLASS (G_OBJECT_GET_CLASS (view))->get_zoom_level (view);
}

/**
 * kraken_view_can_zoom_in:
 *
 * Determine whether the view can be zoomed any closer.
 * @view: The zoomable KrakenView.
 *
 * Return value: TRUE if @view can be zoomed any closer, FALSE otherwise.
 *
 **/
gboolean
kraken_view_can_zoom_in (KrakenView *view)
{
	g_return_val_if_fail (KRAKEN_IS_VIEW (view), FALSE);
	...
	return KRAKEN_VIEW_CLASS (G_OBJECT_GET_CLASS (view))->can_zoom_in (view);
}

/**
 * kraken_view_can_zoom_out:
 *
 ...
 **/
gboolean
kraken_view_can_zoom_out (KrakenView *view)
{
	g_return_val_if_fail (KRAKEN_IS_VIEW (view), FALSE);
	...
	return KRAKEN_VIEW_CLASS (G_OBJECT_GET_CLASS (view))->can_zoom_out (view);
}

gboolean
kraken_view_supports_zooming (KrakenView *view)
{
	g_return_val_if_fail (KRAKEN_IS_VIEW (view), FALSE);
...
/**
 * kraken_view_restore_default_zoom_level:
 *
 * restore to the default zoom level by invoking the relevant subclass through the slot
 *
 **/
void
kraken_view_restore_default_zoom_level (KrakenView *view)
{
	g_return_if_fail (KRAKEN_IS_VIEW (view));
	...
	KRAKEN_VIEW_CLASS (G_OBJECT_GET_CLASS (view))->restore_default_zoom_level (view);
}

/*
static KrakenZoomLevel
kraken_view_get_default_zoom_level (KrakenView *view)
{
    g_return_if_fail (KRAKEN_IS_VIEW (view));
    ...
    KRAKEN_VIEW_CLASS (G_OBJECT_GET_CLASS (view))->get_default_zoom_level (view);
}
*/

const char *
kraken_view_get_view_id (KrakenView *view)
{
	return KRAKEN_VIEW_CLASS (G_OBJECT_GET_CLASS (view))->get_view_id (view);
}

char *
kraken_view_get_first_visible_file (KrakenView *view)
{
	return KRAKEN_VIEW_CLASS (G_OBJECT_GET_CLASS (view))->get_first_visible_file (view);
}

void
kraken_view_scroll_to_file (KrakenView *view,
			      const char *uri)
{
	KRAKEN_VIEW_CLASS (G_OBJECT_GET_CLASS (view))->scroll_to_file (view, uri);
}

/**
 * kraken_view_get_selection:
 *
 * Get a list of KrakenFile pointers that represents the
 ...
 * @view: KrakenView whose selected items are of interest.
 *
 * Return value: GList of KrakenFile pointers representing the selection.
 *
 **/
GList *
kraken_view_get_selection (KrakenView *view)
{
	g_return_val_if_fail (KRAKEN_IS_VIEW (view), NULL);

	return KRAKEN_VIEW_CLASS (G_OBJECT_GET_CLASS (view))->get_selection (view);
}

/**
 * kraken_view_peek_selection:
 *
 * Get a list of KrakenFile pointers that represents the
 * currently-selected items in this view. Subclasses must override
 ...
 **/
GList *
kraken_view_peek_selection (KrakenView *view)
{
    g_return_val_if_fail (KRAKEN_IS_VIEW (view), NULL);

    return KRAKEN_VIEW_CLASS (G_OBJECT_GET_CLASS (view))->peek_selection (view);
}

// int
// kraken_view_get_selection_count (KrakenView *view)
// {
//     g_return_val_if_fail (KRAKEN_IS_VIEW (view), 0);

//     return KRAKEN_VIEW_CLASS (G_OBJECT_GET_CLASS (view))->get_selection_count (view);
// }
 ...
 */
void
kraken_view_update_menus (KrakenView *view)
{
	g_return_if_fail (KRAKEN_IS_VIEW (view));
	...
	KRAKEN_VIEW_CLASS (G_OBJECT_GET_CLASS (view))->update_menus (view);
...
bookmark_callback_data_new (KrakenView *view,
							   gchar *uri)
{
			           ...
			           KrakenView *directory_view)
{
	...
	result->files = kraken_file_list_copy (files);
...
application_launch_parameters_free (ApplicationLaunchParameters *parameters)
{
	...
	kraken_file_list_free (parameters->files);
...
file_and_directory_list_to_files (GList *fad_list)
{
	...
	for (l = fad_list; l != NULL; l = l->next) {
		fad = l->data;
		res = g_list_prepend (res, kraken_file_ref (fad->file));
	}
...
static GList *
file_and_directory_list_from_files (KrakenDirectory *directory, GList *files)
{
	GList *res, *l;
	FileAndDirectory *fad;
	...
	for (l = files; l != NULL; l = l->next) {
		...
		fad->directory = kraken_directory_ref (directory);
		fad->file = kraken_file_ref (l->data);
...
{
	kraken_directory_unref (fad->directory);
	kraken_file_unref (fad->file);
	g_free (fad);
}
...
script_launch_parameters_new (KrakenFile *file,
			      KrakenView *directory_view)
{
...
{
	g_object_unref (parameters->directory_view);
	kraken_file_unref (parameters->file);
	g_free (parameters);
}

static CreateTemplateParameters *
create_template_parameters_new (KrakenFile *file,
				KrakenView *directory_view)
{
...
KrakenWindow *
kraken_view_get_kraken_window (KrakenView  *view)
{
...
KrakenWindowSlot *
kraken_view_get_kraken_window_slot (KrakenView  *view)
{
 ...
 */
static GtkWindow *
kraken_view_get_containing_window (KrakenView *view)
{
	GtkWidget *window;
...
static gboolean
kraken_view_confirm_multiple (GtkWindow *parent_window,
				int count,
				gboolean tabs)
{
	GtkDialog *dialog;
...
static gboolean
selection_contains_one_item_in_menu_callback (KrakenView *view, GList *selection)
{
...
static gboolean
selection_not_empty_in_menu_callback (KrakenView *view, GList *selection)
{
	if (selection != NULL) {
		return TRUE;
	}
...
static char *
get_view_directory (KrakenView *view)
{
	char *uri, *path;
	GFile *f;

	uri = kraken_directory_get_uri (view->details->model);
	if (eel_uri_is_desktop (uri)) {
		g_free (uri);
		uri = kraken_get_desktop_directory_uri ();
...
static gboolean
get_is_desktop_view (KrakenView *view)
{
    gchar *uri;
    gboolean ret;
...
void
kraken_view_preview_files (KrakenView *view,
			     GList *files,
			     GArray *locations)
{
	...
	uri = kraken_file_get_uri (files->data);
	toplevel = gtk_widget_get_toplevel (GTK_WIDGET (view));

    xid = eel_gtk_get_window_xid (GTK_WINDOW (toplevel));

	kraken_previewer_call_show_file (previewer, uri, xid, TRUE);

	g_free (uri);
}

void
kraken_view_activate_files (KrakenView *view,
			      GList *files,
			      ...
			      gboolean confirm_multiple)
{
	...
	kraken_mime_activate_files (kraken_view_get_containing_window (view),
				      view->details->slot,
				      files,
				      path,
				      flags,
	...
	if (get_is_desktop_view(view)) {
		kraken_view_set_selection(view, NULL);
	}
...
void
kraken_view_activate_file (KrakenView *view,
			     KrakenFile *file,
			     KrakenWindowOpenFlags flags)
{
	char *path;
	...
	path = get_view_directory (view);
	kraken_mime_activate_file (kraken_view_get_containing_window (view),
				     view->details->slot,
				     file,
				     path,
				     flags);
		      ...
		      gpointer callback_data)
{
	...
	view = KRAKEN_VIEW (callback_data);

	selection = kraken_view_get_selection (view);
	kraken_view_activate_files (view,
				      selection,
				      0,
				      TRUE);
				   ...
				   gpointer callback_data)
{
	...
	kraken_view_activate_files (view,
				      selection,
				      KRAKEN_WINDOW_OPEN_FLAG_CLOSE_BEHIND,
				      TRUE);
	kraken_file_list_free (selection);
}
				...
				gpointer callback_data)
{
	...
	window = kraken_view_get_containing_window (view);

	if (kraken_view_confirm_multiple (window, g_list_length (selection), FALSE)) {
			      ...
			      gpointer callback_data)
{
	...
	if (kraken_view_confirm_multiple (window, g_list_length (selection), TRUE)) {
		kraken_view_activate_files (view,
					      selection,
					      KRAKEN_WINDOW_OPEN_FLAG_NEW_TAB,
					      FALSE);
	}
				...
				gpointer user_data)
{
    ...
    KrakenMimeApplicationChooser *chooser = children->data;

    g_list_free (children);

	info = kraken_mime_application_chooser_get_info (chooser);
	file = kraken_file_get_by_uri (kraken_mime_application_chooser_get_uri (chooser));

	g_signal_emit_by_name (kraken_signaller_get_current (), "mime_data_changed");

	files.next = NULL;
	files.prev = NULL;
	files.data = file;
	kraken_launch_application (info, &files, parent_window);
...
static void
choose_program (KrakenView *view,
		KrakenFile *file)
{
	GtkWidget *dialog;
    GtkWidget *ok_button;
    ...
    dialog = gtk_dialog_new_with_buttons (_("Open with"),
                          kraken_view_get_containing_window (view),
    ...
    GtkWidget *chooser = kraken_mime_application_chooser_new (uri, uris, mime_type, ok_button);
	...
	g_signal_connect_object (dialog, "response",
				 ...
				 kraken_view_get_containing_window (view), 0);
}

static void
open_with_other_program (KrakenView *view)
{
        GList *selection;
	...
	if (selection_contains_one_item_in_menu_callback (view, selection)) {
		choose_program (view, KRAKEN_FILE (selection->data));
	}
...
action_other_application_callback (GtkAction *action,
				   gpointer callback_data)
{
	g_assert (KRAKEN_IS_VIEW (callback_data));

	open_with_other_program (KRAKEN_VIEW (callback_data));
}

static void
trash_or_delete_selected_files (KrakenView *view)
{
        GList *selection;
	...
	if (!view->details->selection_was_removed) {
		selection = kraken_view_get_selection_for_file_transfer (view);

        if (selection == NULL) {
            return;
        }

		trash_or_delete_files (kraken_view_get_containing_window (view),
				       selection, TRUE,
				       view);
		kraken_file_list_free (selection);
...
action_trash_callback (GtkAction *action,
		       gpointer callback_data)
{
        trash_or_delete_selected_files (KRAKEN_VIEW (callback_data));
}

static void
delete_selected_files (KrakenView *view)
{
        GList *selection;
	GList *node;
	GList *locations;
	...
	for (node = selection; node != NULL; node = node->next) {
		locations = g_list_prepend (locations,
					    kraken_file_get_location ((KrakenFile *) node->data));
	}
	locations = g_list_reverse (locations);

	kraken_file_operations_delete (locations, kraken_view_get_containing_window (view), NULL, NULL);
...
action_delete_callback (GtkAction *action,
			gpointer callback_data)
{
        delete_selected_files (KRAKEN_VIEW (callback_data));
}
				    ...
				    gpointer callback_data)
{
	...
	selection = kraken_view_get_selection_for_file_transfer (view);
	kraken_restore_files_from_trash (selection,
					   kraken_view_get_containing_window (view));
...
static gboolean
real_delete (KrakenView *view)
{
	GtkAction *action;

	action = gtk_action_group_get_action (view->details->dir_action_group,
					      KRAKEN_ACTION_DELETE);
			   ...
			   gpointer callback_data)
{
	...
	if (selection_not_empty_in_menu_callback (view, selection)) {
		 ...
		 */
		selected_item_locations = kraken_view_get_selected_icon_locations (view);
	        kraken_view_duplicate_selection (view, selection, selected_item_locations);
			     ...
			     gpointer callback_data)
{
	...
	if (selection_not_empty_in_menu_callback (view, selection)) {
		selected_item_locations = kraken_view_get_selected_icon_locations (view);
	        kraken_view_create_links_for_files (view, selection, selected_item_locations);
	        g_array_free (selected_item_locations, TRUE);
	}
                                ...
                                gpointer   callback_data)
{
     ...
     * selected file. */
    to_pin = !kraken_file_get_pinning (KRAKEN_FILE (selection->data));
    ...
    if (selection_not_empty_in_menu_callback (view, selection)) {
        ...
        for (iter = selection; iter != NULL; iter = iter->next) {
            file = KRAKEN_FILE (iter->data);

            kraken_file_set_pinning (file, to_pin);
        }
    }
                                          ...
                                          gpointer   callback_data)
{
     ...
     * selected file. */
    to_favorite = !kraken_file_get_is_favorite (KRAKEN_FILE (selection->data));
    ...
    if (selection_not_empty_in_menu_callback (view, selection)) {
        ...
        for (iter = selection; iter != NULL; iter = iter->next) {
            ...
            kraken_file_set_is_favorite (file, to_favorite);
        }
    }
			    ...
			    gpointer callback_data)
{
	...
	kraken_view_select_all (callback_data);
}
				  ...
				  gpointer callback_data)
{
	...
	kraken_view_invert_selection (callback_data);
}
...
pattern_select_response_cb (GtkWidget *dialog, int response, gpointer user_data)
{
	...
	view = KRAKEN_VIEW (user_data);

	switch (response) {
	case GTK_RESPONSE_OK :
		entry = g_object_get_data (G_OBJECT (dialog), "entry");
		directory = kraken_view_get_model (view);
		selection = kraken_directory_match_pattern (directory,
							      gtk_entry_get_text (GTK_ENTRY (entry)));

		if (selection) {
			kraken_view_call_set_selection (view, selection);
			kraken_file_list_free (selection);

			kraken_view_reveal_selection(view);
		}
		/* fall through */
...
static void
select_pattern (KrakenView *view)
{
	GtkWidget *dialog;
	GtkWidget *label;
	GtkWidget *example;
				   ...
				   gpointer callback_data)
{
	...
	kraken_view_reset_to_defaults (callback_data);
}


static void
hidden_files_mode_changed (KrakenWindow *window,
			   gpointer callback_data)
{
	KrakenView *directory_view;
	...
	kraken_view_init_show_hidden_files (directory_view);
}
			     ...
			     gpointer callback_data)
{
	...
	kraken_file_operations_empty_trash (GTK_WIDGET (callback_data));
}
...
delayed_rename_file_hack_callback (RenameData *data)
{
	...
	if (view->details->window != NULL &&
	    view->details->active) {
		KRAKEN_VIEW_CLASS (G_OBJECT_GET_CLASS (view))->start_renaming_file (view, new_file, FALSE);
		kraken_view_reveal_selection (view);
	}
...
delayed_rename_file_hack_removed (RenameData *data)
{
	...
	kraken_file_unref (data->new_file);
	g_free (data);
}


static void
rename_file (KrakenView *view, KrakenFile *new_file)
{
	RenameData *data;
	...
	*/
	if (KRAKEN_IS_LIST_VIEW (view)) {
		kraken_view_select_file (view, new_file);

		data = g_new (RenameData, 1);
		data->view = g_object_ref (view);
		data->new_file = kraken_file_ref (new_file);
...
static void
reveal_newly_added_folder (KrakenView *view, KrakenFile *new_file,
			   KrakenDirectory *directory, GFile *target_location)
{
	GFile *location;

	location = kraken_file_get_location (new_file);
...
static void
track_newly_added_locations (KrakenView *view, KrakenFile *new_file,
			     KrakenDirectory *directory, gpointer user_data)
{
	NewFolderData *data;

	data = user_data;

	g_hash_table_insert (data->added_locations, kraken_file_get_location (new_file), NULL);
}
		 ...
		 gpointer user_data)
{
	...
	file = kraken_file_get (new_folder);
...
new_folder_data_new (KrakenView *directory_view)
{
	NewFolderData *data;
...
static GdkPoint *
context_menu_to_file_operation_position (KrakenView *view)
{
	g_return_val_if_fail (KRAKEN_IS_VIEW (view), NULL);

	if (kraken_view_using_manual_layout (view)
	    && view->details->context_menu_position.x >= 0
	    && view->details->context_menu_position.y >= 0) {
		KRAKEN_VIEW_CLASS (G_OBJECT_GET_CLASS (view))->widget_to_file_operation_position
...
void
kraken_view_new_folder (KrakenView *view)
{
	char *parent_uri;
	NewFolderData *data;
	GdkPoint *pos;
	...
	parent_uri = kraken_view_get_backing_uri (view);
	kraken_file_operations_new_folder (GTK_WIDGET (view),
					     pos, parent_uri,
...
static NewFolderData *
setup_new_folder_data (KrakenView *directory_view)
{
	NewFolderData *data;
...
void
kraken_view_new_file_with_initial_contents (KrakenView *view,
					      ...
					      GdkPoint *pos)
{
	...
	kraken_file_operations_new_file (GTK_WIDGET (view),
...
static void
kraken_view_new_file (KrakenView *directory_view,
			const char *parent_uri,
			KrakenFile *source)
{
	GdkPoint *pos;
	...
	container_uri = NULL;
	if (parent_uri == NULL) {
		container_uri = kraken_view_get_backing_uri (directory_view);
		g_assert (container_uri != NULL);
	}

	if (source == NULL) {
		kraken_view_new_file_with_initial_contents (directory_view,
	...
	g_return_if_fail (kraken_file_is_local (source));

	pos = context_menu_to_file_operation_position (directory_view);

	data = setup_new_folder_data (directory_view);

	source_uri = kraken_file_get_uri (source);

	kraken_file_operations_new_file_from_template (GTK_WIDGET (directory_view),
							 pos,
							 parent_uri != NULL ? parent_uri : container_uri,
							 NULL,
							 source_uri,
			    ...
			    gpointer callback_data)
{
	...
	kraken_view_new_folder (KRAKEN_VIEW (callback_data));
}
				...
				gpointer callback_data)
{
	...
	kraken_view_new_file (KRAKEN_VIEW (callback_data), NULL, NULL);
}
			    ...
			    gpointer callback_data)
{
	...
	if (g_list_length (selection) == 0) {
		if (view->details->directory_as_file != NULL) {
            if (KRAKEN_IS_SEARCH_DIRECTORY (view->details->model)) {
                files = kraken_directory_get_file_list (view->details->model);
            } else {
                files = g_list_append (NULL, kraken_file_ref (view->details->directory_as_file));
            }

			kraken_properties_window_present (files, GTK_WIDGET (view), NULL);

			kraken_file_list_free (files);
		}
	} else {
		kraken_properties_window_present (selection, GTK_WIDGET (view), NULL);
	}
        kraken_file_list_free (selection);
}
				     ...
				     gpointer   callback_data)
{
	...
	view = KRAKEN_VIEW (callback_data);
	g_assert (KRAKEN_IS_FILE (view->details->location_popup_directory_as_file));

    if (KRAKEN_IS_SEARCH_DIRECTORY (view->details->model)) {
        files = kraken_directory_get_file_list (view->details->model);
    } else {
        files = g_list_append (NULL, kraken_file_ref (view->details->location_popup_directory_as_file));
    }
...
all_files_in_trash (GList *files)
{
	...
	for (node = files; node != NULL; node = node->next) {
		if (!kraken_file_is_in_trash (KRAKEN_FILE (node->data))) {
			return FALSE;
		}
	}
...
static gboolean
all_selected_items_in_trash (KrakenView *view, GList *selection)
{
	gboolean result;
...
click_policy_changed_callback (gpointer callback_data)
{
	...
	KRAKEN_VIEW_CLASS (G_OBJECT_GET_CLASS (view))->click_policy_changed (view);
}
...
click_to_rename_changed_callback (gpointer callback_data)
{
    ...
    KRAKEN_VIEW_CLASS (G_OBJECT_GET_CLASS (view))->click_to_rename_mode_changed (view);
}

static void
kraken_to_menu_preferences_changed_callback (KrakenView *view)
{
    view->details->showing_bookmarks_in_to_menus = g_settings_get_boolean (kraken_preferences,
                                                                           KRAKEN_PREFERENCES_SHOW_BOOKMARKS_IN_TO_MENUS);
    view->details->showing_places_in_to_menus = g_settings_get_boolean (kraken_preferences,
                                                                        KRAKEN_PREFERENCES_SHOW_PLACES_IN_TO_MENUS);
}

gboolean
kraken_view_should_sort_directories_first (KrakenView *view)
{
	return view->details->sort_directories_first;
}

gboolean
kraken_view_should_sort_favorites_first (KrakenView *view)
{
...
sort_directories_first_changed_callback (gpointer callback_data)
{
	...
	preference_value =
		g_settings_get_boolean (kraken_preferences, KRAKEN_PREFERENCES_SORT_DIRECTORIES_FIRST);

	if (preference_value != view->details->sort_directories_first) {
		view->details->sort_directories_first = preference_value;
		return KRAKEN_VIEW_CLASS (G_OBJECT_GET_CLASS (view))->sort_directories_first_changed (view);
	}
}
...
sort_favorites_first_changed_callback (gpointer callback_data)
{
	...
	preference_value =
		g_settings_get_boolean (kraken_preferences, KRAKEN_PREFERENCES_SORT_FAVORITES_FIRST);

	if (preference_value != view->details->sort_favorites_first) {
		view->details->sort_favorites_first = preference_value;
		return KRAKEN_VIEW_CLASS (G_OBJECT_GET_CLASS (view))->sort_favorites_first_changed (view);
	}
}
...
{
    GtkBindingSet *binding_set = gtk_binding_set_find ("KrakenView");

    gboolean swap_keys = g_settings_get_boolean (kraken_preferences, KRAKEN_PREFERENCES_SWAP_TRASH_DELETE);
...
set_up_scripts_directory_global (void)
{
	...
	scripts_directory_path = kraken_get_scripts_directory_path ();
...
static void
scripts_added_or_changed_callback (KrakenDirectory *directory,
				   GList *files,
				   gpointer callback_data)
{
	KrakenView *view;
...
static void
templates_added_or_changed_callback (KrakenDirectory *directory,
				     GList *files,
				     gpointer callback_data)
{
	KrakenView *view;
...
static void
actions_added_or_changed_callback (KrakenView *view)
{
...
static void
add_directory_to_directory_list (KrakenView *view,
				 KrakenDirectory *directory,
				 ...
				 GCallback changed_callback)
{
	...
	if (g_list_find (*directory_list, directory) == NULL) {
		...
		kraken_directory_file_monitor_add (directory, directory_list,
						     FALSE, attributes,
						     (KrakenDirectoryCallback)changed_callback, view);
...
static void
remove_directory_from_directory_list (KrakenView *view,
				      KrakenDirectory *directory,
				      GList **directory_list,
				      GCallback changed_callback)
{
	*directory_list = g_list_remove	(*directory_list, directory);
	...
	kraken_directory_file_monitor_remove (directory, directory_list);

	kraken_directory_unref (directory);
}

static void
add_directory_to_scripts_directory_list (KrakenView *view,
					 KrakenDirectory *directory)
{
...
static void
remove_directory_from_scripts_directory_list (KrakenView *view,
					      KrakenDirectory *directory)
{
...
static void
add_directory_to_templates_directory_list (KrakenView *view,
					   KrakenDirectory *directory)
{
	add_directory_to_directory_list (view, directory,
...
static void
remove_directory_from_templates_directory_list (KrakenView *view,
						KrakenDirectory *directory)
{
	remove_directory_from_directory_list (view, directory,
					      &view->details->templates_directory_list,
...
static void
slot_active (KrakenWindowSlot *slot,
	     KrakenView *view)
{
	if (view->details->active) {
		return;
	...
	kraken_view_merge_menus (view);
	schedule_update_menus (view);
}

static void
slot_inactive (KrakenWindowSlot *slot,
	       KrakenView *view)
{
	if (!view->details->active) {
		return;
	...
	kraken_view_unmerge_menus (view);
	remove_update_menus_timeout_callback (view);
}

static void slot_changed_pane (KrakenWindowSlot *slot,
			       KrakenView *view)
{
	...
	view->details->window = kraken_window_slot_get_window (slot);
	schedule_update_menus (view);
...
void
kraken_view_grab_focus (KrakenView *view)
{
...
kraken_view_get_selection_count (KrakenView *view)
{
    ...
    files = kraken_view_get_selection (KRAKEN_VIEW (view));
...
static void
update_undo_actions (KrakenView *view)
{
	KrakenFileUndoInfo *info;
	KrakenFileUndoManagerState undo_state;
	GtkAction *action;
	...
	info = kraken_file_undo_manager_get_action ();
	undo_state = kraken_file_undo_manager_get_state ();

	if (info != NULL &&
	    (undo_state > KRAKEN_FILE_UNDO_MANAGER_STATE_NONE)) {
		if (undo_state == KRAKEN_FILE_UNDO_MANAGER_STATE_UNDO) {
			undo_active = TRUE;
		} else {
			redo_active = TRUE;
		}

		kraken_file_undo_info_get_strings (info,
...
static void
undo_manager_changed_cb (KrakenFileUndoManager* manager,
			 KrakenView *view)
{
...
void
kraken_view_set_selection (KrakenView *kraken_view,
			     GList *selection)
{
	KrakenView *view;

	view = KRAKEN_VIEW (kraken_view);
...
get_bulk_rename_tool (void)
{
	...
	g_settings_get (kraken_preferences, KRAKEN_PREFERENCES_BULK_RENAME_TOOL, "^ay", &bulk_rename_tool);
...
static void
kraken_view_init (KrakenView *view)
{
	AtkObject *atk_object;
	KrakenDirectory *scripts_directory;
	KrakenDirectory *templates_directory;
	char *templates_uri;
	KrakenFileUndoManager* manager;
	view->details = G_TYPE_INSTANCE_GET_PRIVATE (view, KRAKEN_TYPE_VIEW,
						     KrakenViewDetails);
	...
	if (set_up_scripts_directory_global ()) {
		scripts_directory = kraken_directory_get_by_uri (scripts_directory_uri);
		add_directory_to_scripts_directory_list (view, scripts_directory);
		kraken_directory_unref (scripts_directory);
	} else {
		g_warning ("Ignoring scripts directory, it may be a broken link\n");
	}

	if (kraken_should_use_templates_directory ()) {
		templates_uri = kraken_get_templates_directory_uri ();
		templates_directory = kraken_directory_get_by_uri (templates_uri);
		g_free (templates_uri);
		add_directory_to_templates_directory_list (view, templates_directory);
		kraken_directory_unref (templates_directory);
	}
	update_templates_directory (view);
	g_signal_connect_object (kraken_signaller_get_current (),
				 "user_dirs_changed",
	...
	g_signal_connect_object (kraken_trash_monitor_get (), "trash_state_changed",
				 G_CALLBACK (kraken_view_trash_state_changed_callback), view, 0);

	/* React to clipboard changes */
	g_signal_connect_object (kraken_clipboard_monitor_get (), "clipboard_changed",
	...
	g_signal_connect_object (kraken_signaller_get_current (), "popup_menu_changed",
				 G_CALLBACK (kraken_view_update_menus), view, G_CONNECT_SWAPPED);

	gtk_widget_show (GTK_WIDGET (view));

	g_signal_connect_swapped (kraken_preferences,
				  "changed::" KRAKEN_PREFERENCES_ENABLE_DELETE,
				  G_CALLBACK (schedule_update_menus_callback), view);
    g_signal_connect_swapped (kraken_menu_config_preferences,
                              "changed",
                              G_CALLBACK (schedule_update_menus_callback), view);
    g_signal_connect_swapped (kraken_preferences,
                  "changed::" KRAKEN_PREFERENCES_SWAP_TRASH_DELETE,
                  G_CALLBACK (swap_delete_keybinding_changed_callback), view);
	g_signal_connect_swapped (kraken_preferences,
				  "changed::" KRAKEN_PREFERENCES_CLICK_POLICY,
				  G_CALLBACK(click_policy_changed_callback),
				  view);
    g_signal_connect_swapped (kraken_preferences,
                  "changed::" KRAKEN_PREFERENCES_CLICK_TO_RENAME,
                  G_CALLBACK(click_to_rename_changed_callback),
                  view);
	g_signal_connect_swapped (kraken_preferences,
				  "changed::" KRAKEN_PREFERENCES_SORT_DIRECTORIES_FIRST,
				  G_CALLBACK(sort_directories_first_changed_callback), view);
	g_signal_connect_swapped (kraken_preferences,
				  "changed::" KRAKEN_PREFERENCES_SORT_FAVORITES_FIRST,
	...
	g_signal_connect_swapped (kraken_window_state,
				  "changed::" KRAKEN_WINDOW_STATE_START_WITH_STATUS_BAR,
				  G_CALLBACK (kraken_view_display_selection_info), view);

    g_signal_connect_swapped (kraken_preferences,
                  "changed::" KRAKEN_PREFERENCES_SHOW_BOOKMARKS_IN_TO_MENUS,
                  G_CALLBACK (kraken_to_menu_preferences_changed_callback), view);
    g_signal_connect_swapped (kraken_preferences,
                  "changed::" KRAKEN_PREFERENCES_SHOW_PLACES_IN_TO_MENUS,
                  G_CALLBACK (kraken_to_menu_preferences_changed_callback), view);

    kraken_to_menu_preferences_changed_callback (view);

	manager = kraken_file_undo_manager_get ();
	g_signal_connect_object (manager, "undo-changed",
				 G_CALLBACK (undo_manager_changed_cb), view, 0);

    g_signal_connect (kraken_plugin_preferences,
                      "changed::" KRAKEN_PLUGIN_PREFERENCES_DISABLED_SCRIPTS,
    ...
    view->details->action_manager = kraken_action_manager_new ();
    ...
    view->details->bookmarks = kraken_bookmark_list_get_default ();
...
static void
disconnect_action_activate (KrakenAction *action, KrakenView *view)
{
    g_signal_handlers_disconnect_by_func (action, run_action_callback, view);
}

static void
real_unmerge_menus (KrakenView *view)
{
	...
	ui_manager = kraken_window_get_ui_manager (view->details->window);
...
static void
kraken_view_destroy (GtkWidget *object)
{
	KrakenView *view;
	GList *node, *next;

	view = KRAKEN_VIEW (object);
	...
	while (view->details->subdirectory_list != NULL) {
		kraken_view_remove_subdirectory (view,
	...
	if (view->details->model) {
		kraken_directory_unref (view->details->model);
		view->details->model = NULL;
	}

	if (view->details->directory_as_file) {
		kraken_file_unref (view->details->directory_as_file);
		view->details->directory_as_file = NULL;
	}

    g_signal_handlers_disconnect_by_func (kraken_plugin_preferences, G_CALLBACK (plugin_prefs_changed), view);

	GTK_WIDGET_CLASS (kraken_view_parent_class)->destroy (object);
}

static void
kraken_view_finalize (GObject *object)
{
	KrakenView *view;
	...
	g_signal_handlers_disconnect_by_func (kraken_window_state,
					      kraken_view_display_selection_info, view);
    g_signal_handlers_disconnect_by_func (kraken_menu_config_preferences,
                          schedule_update_menus_callback, view);
	...
	G_OBJECT_CLASS (kraken_view_parent_class)->finalize (object);
}

/**
 * kraken_view_display_selection_info:
 *
 * Display information about the current selection, and notify the view frame of the changed selection.
 * @view: KrakenView for which to display selection info.
 *
 **/
void
kraken_view_display_selection_info (KrakenView *view)
{
	GList *selection;
	...
	for (p = selection; p != NULL; p = p->next) {
		...
		if (kraken_file_is_directory (file)) {
			folder_count++;
			if (kraken_file_get_directory_item_count (file, &file_item_count, NULL)) {
			...
			non_folder_count++;
			if (!kraken_file_can_get_size (file)) {
				non_folder_size_known = TRUE;
				non_folder_size += kraken_file_get_size (file);
			}
		}

		if (first_item_name == NULL) {
			first_item_name = kraken_file_get_display_name (file);
		}
	}
	...
	free_space_str = kraken_file_get_volume_free_space (view->details->directory_as_file);
	...
	if (folder_count == 0 && non_folder_count == 0)	{
		...
		item_count = kraken_view_get_item_count (view);
    ...
    kraken_window_slot_set_status (view->details->slot,
                                 status_string,
                                 view_status_string,
...
static void
kraken_view_send_selection_change (KrakenView *view)
{
...
void
kraken_view_load_location (KrakenView *kraken_view,
			     GFile        *location)
{
	KrakenDirectory *directory;
	KrakenView *directory_view;

	directory_view = KRAKEN_VIEW (kraken_view);
...
{
    g_return_val_if_fail (KRAKEN_IS_VIEW (user_data), G_SOURCE_REMOVE);
	      ...
	      gboolean all_files_seen)
{
	 ...
	 * is no KrakenWindow any more.
	 */
	if (view->details->window != NULL) {
		if (all_files_seen) {
			kraken_window_report_load_complete (view->details->window, KRAKEN_VIEW (view));
		}
    ...
    if (g_getenv("KRAKEN_BENCHMARK_LOADING")) {
        if (kraken_startup_timer != NULL) {
            g_printerr ("Kraken startup time: %f seconds\n", g_timer_elapsed (kraken_startup_timer, NULL));
            g_clear_pointer (&kraken_startup_timer, g_timer_destroy);
        }
...
debuting_files_data_free (DebutingFilesData *data)
{
	...
	kraken_file_list_free (data->added_files);
	g_free (data);
}
 ...
 */
static void
debuting_files_add_file_callback (KrakenView *view,
				  KrakenFile *new_file,
				  KrakenDirectory *directory,
...
static void
pre_copy_move_add_file_callback (KrakenView *view,
				 KrakenFile *new_file,
				 KrakenDirectory *directory,
...
/* This needs to be called prior to kraken_file_operations_copy_move.
...
pre_copy_move (KrakenView *directory_view)
{
...
copy_move_done_partition_func (gpointer data, gpointer callback_data)
{
	...
	location = kraken_file_get_location (KRAKEN_FILE (data));
			 ...
			 gpointer data)
{
	...
	if (directory_view != NULL) {
		g_assert (KRAKEN_IS_VIEW (directory_view));
		...
		if (g_hash_table_size (debuting_files) == 0) {
			...
			if (debuting_files_data->added_files != NULL) {
				kraken_view_call_set_selection (directory_view,
								  debuting_files_data->added_files);
				kraken_view_reveal_selection (directory_view);
			}
...
static gboolean
view_file_still_belongs (KrakenView *view,
			 KrakenFile *file,
			 KrakenDirectory *directory)
{
	...
	return kraken_directory_contains_file (directory, file);
}

static gboolean
still_should_show_file (KrakenView *view, KrakenFile *file, KrakenDirectory *directory)
{
	return kraken_view_should_show_file (view, file) &&
		view_file_still_belongs (view, file, directory);
}

static gboolean
ready_to_load (KrakenFile *file)
{
	return kraken_file_check_if_ready (file,
					     KRAKEN_FILE_ATTRIBUTES_FOR_ICON);
}
...
compare_files_cover (gconstpointer a, gconstpointer b, gpointer callback_data)
{
	...
	if (fad1->directory < fad2->directory) {
		...
		return KRAKEN_VIEW_CLASS (G_OBJECT_GET_CLASS (view))->compare_files (view, fad1->file, fad2->file);
	}
}
static void
sort_files (KrakenView *view, GList **list)
{
 ...
 */
static void
process_new_files (KrakenView *view)
{
	...
	for (node = new_added_files; node != NULL; node = next) {
		...
		if (kraken_view_should_show_file (view, pending->file)) {
	...
	for (node = new_changed_files; node != NULL; node = next) {
		...
		if (!still_should_show_file (view, pending->file, pending->directory) || ready_to_load (pending->file)) {
			...
			} else if (kraken_view_should_show_file (view, pending->file)) {
				new_changed_files = g_list_delete_link (new_changed_files, node);
...
static void
process_old_files (KrakenView *view)
{
	...
	if (send_selection_change) {
		 ...
		 * have changed.
		 */
		kraken_view_send_selection_change (view);
	}
}

static void
display_pending_files (KrakenView *view)
{
	...
	if (view->details->model != NULL
	    && kraken_directory_are_all_files_seen (view->details->model)
...
void
kraken_view_freeze_updates (KrakenView *view)
{
...
void
kraken_view_unfreeze_updates (KrakenView *view)
{
...
static void
remove_update_menus_timeout_callback (KrakenView *view)
{
...
static void
update_menus_if_pending (KrakenView *view)
{
	if (!view->details->menu_states_untrustworthy) {
		return;
	}
...
static void
schedule_idle_display_of_pending_files (KrakenView *view)
{
...
static void
schedule_timeout_display_of_pending_files (KrakenView *view, guint interval)
{
...
static void
unschedule_display_of_pending_files (KrakenView *view)
{
...
static void
queue_pending_files (KrakenView *view,
		     KrakenDirectory *directory,
		     GList *files,
		     GList **pending_list)
{
...
static void
remove_changes_timeout_callback (KrakenView *view)
{
...
static void
reset_update_interval (KrakenView *view)
{
...
static void
schedule_changes (KrakenView *view)
{
...
static void
files_added_callback (KrakenDirectory *directory,
		      GList *files,
		      gpointer callback_data)
{
	KrakenView *view;
...
static void
files_changed_callback (KrakenDirectory *directory,
			GList *files,
			gpointer callback_data)
{
	KrakenView *view;
...
static void
done_loading_callback (KrakenDirectory *directory,
		       gpointer callback_data)
{
	KrakenView *view;
...
static void
load_error_callback (KrakenDirectory *directory,
		     GError *error,
		     gpointer callback_data)
{
	KrakenView *view;
    ...
    kraken_window_back_or_forward (KRAKEN_WINDOW (view->details->window),
                                 TRUE, 0, FALSE);
...
static void
real_load_error (KrakenView *view, GError *error)
{
	/* Report only one error per failed directory load (from the UI
	 * point of view, not from the KrakenDirectory point of view).
	...
	if (!view->details->reported_load_error) {
		kraken_report_error_loading_directory
			(kraken_view_get_directory_as_file (view),
			 error,
			 kraken_view_get_containing_window (view));
	}
...
void
kraken_view_add_subdirectory (KrakenView  *view,
				KrakenDirectory*directory)
{
	KrakenFileAttributes attributes;
	...
	kraken_directory_file_monitor_add (directory,
					     &view->details->model,
...
void
kraken_view_remove_subdirectory (KrakenView  *view,
				   KrakenDirectory*directory)
{
	g_assert (g_list_find (view->details->subdirectory_list, directory));
	...
	kraken_directory_file_monitor_remove (directory, &view->details->model);

	kraken_directory_unref (directory);
}

/**
 * kraken_view_get_loading:
 * @view: an #KrakenView.
 *
 ...
 **/
gboolean
kraken_view_get_loading (KrakenView *view)
{
	g_return_val_if_fail (KRAKEN_IS_VIEW (view), FALSE);
...
GtkUIManager *
kraken_view_get_ui_manager (KrakenView  *view)
{
	if (view->details->window == NULL) {
		return NULL;
	}
	return kraken_window_get_ui_manager (view->details->window);
}

/**
 * kraken_view_get_model:
 *
 * Get the model for this KrakenView.
 * @view: KrakenView of interest.
 *
 * Return value: KrakenDirectory for this view.
 *
 **/
KrakenDirectory *
kraken_view_get_model (KrakenView *view)
{
	g_return_val_if_fail (KRAKEN_IS_VIEW (view), NULL);
...
GdkAtom
kraken_view_get_copied_files_atom (KrakenView *view)
{
	g_return_val_if_fail (KRAKEN_IS_VIEW (view), GDK_NONE);
...
prepend_uri_one (gpointer data, gpointer callback_data)
{
	...
	*result = g_list_prepend (*result, kraken_file_get_uri (file));
}
...
static void
kraken_view_create_links_for_files (KrakenView *view, GList *files,
				      GArray *relative_item_points)
{
	...
	dir_uri = kraken_view_get_backing_uri (view);
	kraken_file_operations_copy_move (uris, relative_item_points, dir_uri, GDK_ACTION_LINK,
...
static void
kraken_view_duplicate_selection (KrakenView *view, GList *files,
				   GArray *relative_item_points)
{
	GList *uris;
	CopyMoveDoneData *copy_move_done_data;
	...
	offset_drop_points (relative_item_points,
        ...
        copy_move_done_data = pre_copy_move (view);
	kraken_file_operations_copy_move (uris, relative_item_points, NULL, GDK_ACTION_COPY,
					    GTK_WIDGET (view), copy_move_done_callback, copy_move_done_data);
	g_list_free_full (uris, g_free);
}
 ...
 *	 KRAKEN_DESKTOP_LINK_TRASH, KRAKEN_DESKTOP_LINK_HOME, KRAKEN_DESKTOP_LINK_MOUNT
 */

static gboolean
special_link_in_selection (KrakenView *view, GList *selection)
{
	gboolean saw_link;
	GList *node;
	KrakenFile *file;
	...
	for (node = selection; node != NULL; node = node->next) {
		...
		saw_link = KRAKEN_IS_DESKTOP_ICON_FILE (file);
...
static gboolean
desktop_or_home_dir_in_selection (KrakenView *view, GList *selection)
{
	...
	for (node = selection; node != NULL; node = node->next) {
		...
		saw_desktop_or_home_dir =
			...
			|| kraken_file_is_desktop_directory (file);
...
static gboolean
directory_in_selection (KrakenView *view, GList *selection)
{
    gboolean has_dir;
    GList *node;
    KrakenFile *file;
    ...
    for (node = selection; node != NULL; node = node->next) {
        ...
        has_dir = kraken_file_is_directory (file);
        if (has_dir) {
            break;
        }
    }
		       ...
		       KrakenView *view)
{
	...
	kraken_file_operations_trash_or_delete (locations,
						  parent_window,
						  (KrakenDeleteCallback) trash_or_delete_done_cb,
						  view);
	g_list_free_full (locations, g_object_unref);
}

static gboolean
can_rename_file (KrakenView *view, KrakenFile *file)
{
	return kraken_file_can_rename (file);
}

gboolean
kraken_view_get_is_renaming (KrakenView *view)
{
	return view->details->is_renaming;
}

void
kraken_view_set_is_renaming (KrakenView *view,
			       gboolean      is_renaming)
{
...
static void
start_renaming_file (KrakenView *view,
		     KrakenFile *file,
		     gboolean select_all)
{
	...
	if (file !=  NULL) {
		kraken_view_select_file (view, file);
	}
}

static void
update_context_menu_position_from_event (KrakenView *view,
...
open_one_in_new_window (gpointer data, gpointer callback_data)
{
	...
	kraken_view_activate_file (KRAKEN_VIEW (callback_data),
				     KRAKEN_FILE (data),
				     KRAKEN_WINDOW_OPEN_FLAG_NEW_WINDOW);
}

KrakenFile *
kraken_view_get_directory_as_file (KrakenView *view)
{
	g_assert (KRAKEN_IS_VIEW (view));
				       ...
				       gpointer callback_data)
{
	...
	kraken_launch_application
		(launch_parameters->application,
		 launch_parameters->files,
		 kraken_view_get_containing_window (launch_parameters->directory_view));
}
...
static void
add_application_to_open_with_menu (KrakenView *view,
				   GAppInfo *application,
				   GList *files,
				   int index,
...
static void
add_x_content_apps (KrakenView *view, KrakenFile *file, GList **applications)
{
	GMount *mount;
	...
	x_content_types = kraken_get_cached_x_content_types_for_mount (mount);
...
static void
reset_open_with_menu (KrakenView *view, GList *selection, gboolean filter_default)
{
	...
	kraken_ui_prepare_merge_ui (ui_manager,
				      "OpenWithGroup",
				      &view->details->open_with_merge_id,
				      &view->details->open_with_action_group);
	...
	for (node = selection; node != NULL; node = node->next) {
		...
		other_applications_visible &= (!kraken_mime_file_opens_in_view (file) ||
                                        kraken_file_is_directory (file));
	}

	default_app = NULL;
	if (filter_default && selection != NULL) {
		default_app = kraken_mime_get_default_application_for_files (selection);
	}

	applications = NULL;
	if (other_applications_visible) {
		applications = kraken_mime_get_applications_for_files (selection);
	}

	if (g_list_length (selection) == 1) {
		add_x_content_apps (view, KRAKEN_FILE (selection->data), &applications);
	}
	...
	for (node = applications, index = 0; node != NULL; node = node->next, index++) {
		...
		if (submenu_visible) {
			menu_path = (char *)KRAKEN_VIEW_MENU_PATH_APPLICATIONS_SUBMENU_PLACEHOLDER;
			popup_path = (char *)KRAKEN_VIEW_POPUP_PATH_APPLICATIONS_SUBMENU_PLACEHOLDER;
		} else {
			menu_path = (char *)KRAKEN_VIEW_MENU_PATH_APPLICATIONS_PLACEHOLDER;
			popup_path = (char *)KRAKEN_VIEW_POPUP_PATH_APPLICATIONS_PLACEHOLDER;
		}

		gtk_ui_manager_add_ui (kraken_window_get_ui_manager (view->details->window),
				       view->details->open_with_merge_id,
				       menu_path,
				       "separator",
				       NULL,
	...
	if (submenu_visible) {
		action = gtk_action_group_get_action (view->details->dir_action_group,
						      KRAKEN_ACTION_OTHER_APPLICATION1);
		gtk_action_set_visible (action, open_with_chooser_visible);
		action = gtk_action_group_get_action (view->details->dir_action_group,
						      KRAKEN_ACTION_OTHER_APPLICATION2);
...
static void
move_copy_selection_to_location (KrakenView *view,
                 int copy_action,
                 char *target_uri)
{
    ...
    for (l = selection; l != NULL; l = l->next) {
        uris = g_list_prepend (uris,
                       kraken_file_get_uri ((KrakenFile *) l->data));
    }
    uris = g_list_reverse (uris);

    kraken_view_move_copy_items (view, uris, NULL, target_uri,
                       copy_action,
                       0, 0);
...
static void
add_bookmark_to_action (KrakenView *view, const gchar *bookmark_name, const gchar *icon_name, gchar *mount_uri, gint index)
{
    GtkUIManager *ui_manager;
    ui_manager = kraken_window_get_ui_manager (view->details->window);
    ...
    setup_bookmark_action(g_strdup_printf ("BM_MOVETO_POPUP_%d", index),
                                            ...
                                            KRAKEN_VIEW_POPUP_PATH_BOOKMARK_MOVETO_ENTRIES_PLACEHOLDER,
                                            view);
    ...
    setup_bookmark_action(g_strdup_printf ("BM_COPYTO_POPUP_%d", index),
                                            ...
                                            KRAKEN_VIEW_POPUP_PATH_BOOKMARK_COPYTO_ENTRIES_PLACEHOLDER,
                                            view);
    ...
    setup_bookmark_action(g_strdup_printf ("BM_MOVETO_MENU_%d", index),
                                            ...
                                            KRAKEN_VIEW_MENU_PATH_BOOKMARK_MOVETO_ENTRIES_PLACEHOLDER,
                                            view);
    ...
    setup_bookmark_action(g_strdup_printf ("BM_COPYTO_MENU_%d", index),
                                            ...
                                            KRAKEN_VIEW_MENU_PATH_BOOKMARK_COPYTO_ENTRIES_PLACEHOLDER,
                                            view);
}

static void
add_place_to_action (KrakenView *view, const gchar *bookmark_name, const gchar *icon_name, gchar *mount_uri, gint index)
{
    GtkUIManager *ui_manager;
    ui_manager = kraken_window_get_ui_manager (view->details->window);
    ...
    setup_bookmark_action(g_strdup_printf ("PLACE_MOVETO_POPUP_%d", index),
                                            ...
                                            view->details->copy_move_action_groups[0],
                                            view->details->copy_move_merge_ids[0],
                                            KRAKEN_VIEW_POPUP_PATH_PLACES_MOVETO_ENTRIES_PLACEHOLDER,
                                            view);
    ...
    setup_bookmark_action(g_strdup_printf ("PLACE_COPYTO_POPUP_%d", index),
                                            ...
                                            view->details->copy_move_action_groups[1],
                                            view->details->copy_move_merge_ids[1],
                                            KRAKEN_VIEW_POPUP_PATH_PLACES_COPYTO_ENTRIES_PLACEHOLDER,
                                            view);
    ...
    setup_bookmark_action(g_strdup_printf ("PLACE_MOVETO_MENU_%d", index),
                                            ...
                                            view->details->copy_move_action_groups[2],
                                            view->details->copy_move_merge_ids[2],
                                            KRAKEN_VIEW_MENU_PATH_PLACES_MOVETO_ENTRIES_PLACEHOLDER,
                                            view);
    ...
    setup_bookmark_action(g_strdup_printf ("PLACE_COPYTO_MENU_%d", index),
                                            ...
                                            view->details->copy_move_action_groups[3],
                                            view->details->copy_move_merge_ids[3],
                                            KRAKEN_VIEW_MENU_PATH_PLACES_COPYTO_ENTRIES_PLACEHOLDER,
                                            view);
}

static void
reset_move_copy_to_menu (KrakenView *view)
{
    ...
    mount_uri = kraken_get_home_directory_uri ();
    file = kraken_file_get_by_uri (mount_uri);
    g_free (mount_uri);

    icon_name = kraken_file_get_control_icon_name (file);

    action = gtk_action_group_get_action (view->details->dir_action_group, KRAKEN_ACTION_COPY_TO_HOME);
    gtk_action_set_icon_name (action, icon_name);

    action = gtk_action_group_get_action (view->details->dir_action_group, KRAKEN_ACTION_MOVE_TO_HOME);
    gtk_action_set_icon_name (action, icon_name);

    g_clear_pointer (&icon_name, g_free);
    kraken_file_unref (file);

    mount_uri = kraken_get_desktop_directory_uri ();
    file = kraken_file_get_by_uri (mount_uri);
    g_free (mount_uri);

    icon_name = kraken_file_get_control_icon_name (file);

    action = gtk_action_group_get_action (view->details->dir_action_group, KRAKEN_ACTION_COPY_TO_DESKTOP);
    gtk_action_set_icon_name (action, icon_name);

    action = gtk_action_group_get_action (view->details->dir_action_group, KRAKEN_ACTION_MOVE_TO_DESKTOP);
    gtk_action_set_icon_name (action, icon_name);
    ...
    if (view->details->showing_bookmarks_in_to_menus) {
        bookmark_count = kraken_bookmark_list_length (view->details->bookmarks);
        for (index = 0; index < bookmark_count; ++index) {
            bookmark = kraken_bookmark_list_item_at (view->details->bookmarks, index);
            ...
            root = kraken_bookmark_get_location (bookmark);
            file = kraken_file_get (root);

            kraken_file_unref (file);

            bookmark_name = kraken_bookmark_get_name (bookmark);
            icon_name = kraken_bookmark_get_icon_name (bookmark);
            mount_uri = kraken_bookmark_get_uri (bookmark);
    ...
    if (view->details->showing_places_in_to_menus) {
        ...
        for (l = mounts; l != NULL; l = l->next) {
            ...
            icon_name = kraken_get_mount_icon_name (mount);
...
static void
disconnect_bookmark_signals (KrakenView *view)
{
    int i;
    GList *list;
			      ...
			      GList *selection)
{
	...
	for (l = providers; l != NULL; l = l->next) {
		...
		file_items = kraken_menu_provider_get_file_items (provider,
								    window,
								    selection);
...
extension_action_callback_data_free (ExtensionActionCallbackData *data)
{
	...
	kraken_file_list_free (data->selection);
...
search_in_menu_items (GList* items, const char *item_name)
{
	...
	for (list = items; list != NULL; list = list->next) {
		...
		if (menu != NULL) {
			...
			submenus = kraken_menu_get_items (menu);
			ret = search_in_menu_items (submenus, item_name);
			kraken_menu_item_list_free (submenus);
			g_object_unref (menu);
			if (ret) {
				return TRUE;
			}
			   ...
			   gpointer callback_data)
{
	...
	if (is_valid) {
		kraken_menu_item_activate (data->item);
	}
}

static GdkPixbuf *
get_menu_icon_for_file (KrakenFile *file,
                        GtkWidget *widget)
{
	KrakenIconInfo *info;
	GdkPixbuf *pixbuf;
	...
	size = kraken_get_icon_size_for_stock_size (GTK_ICON_SIZE_MENU);
    scale = gtk_widget_get_scale_factor (widget);

	info = kraken_file_get_icon (file, size, 0, scale, 0);
	pixbuf = kraken_icon_info_get_pixbuf_nodefault_at_size (info, size);
...
static GtkAction *
add_extension_action_for_files (KrakenView *view,
				KrakenMenuItem *item,
				GList *files)
{
    GtkAction *ret = NULL;
    ...
    if (widget_a == NULL && !separator) {
        ...
        action = kraken_separator_action_new (name);
    } else {
        action = kraken_widget_action_new (name, widget_a, widget_b);
    }
	...
	data->view = view;
	data->selection = kraken_file_list_copy (files);
	data->action = action;
...
static void
add_extension_menu_items (KrakenView *view,
			  GList *files,
			  GList *menu_items,
			  const char *subdirectory)
{
	...
	for (l = menu_items; l; l = l->next) {
        ...
        if (action) {
            ...
            if (G_OBJECT_TYPE (action) == KRAKEN_TYPE_SEPARATOR_ACTION)
                item_type = GTK_UI_MANAGER_SEPARATOR;
            else {
                item_type = (menu != NULL) ? GTK_UI_MANAGER_MENU : GTK_UI_MANAGER_MENUITEM;
            }
    		path = g_build_path ("/", KRAKEN_VIEW_POPUP_PATH_EXTENSION_ACTIONS, subdirectory, NULL);
    		gtk_ui_manager_add_ui (ui_manager,
    				       view->details->extensions_menu_merge_id,
    				       path,
    		...
    		path = g_build_path ("/", KRAKEN_VIEW_MENU_PATH_EXTENSION_ACTIONS_PLACEHOLDER, subdirectory, NULL);
    		gtk_ui_manager_add_ui (ui_manager,
    				       view->details->extensions_menu_merge_id,
    				       path,
    				       gtk_action_get_name (action),
...
static void
reset_extension_actions_menu (KrakenView *view, GList *selection)
{
	GList *items;
	GtkUIManager *ui_manager;
...
static char *
change_to_view_directory (KrakenView *view)
{
	char *path;
	char *old_path;
				   ...
				   KrakenDirectory *model)
{
	...
	model_location = kraken_directory_get_location (model);

	for (node = selection, i = 0; node != NULL; node = node->next, i++) {
		file = KRAKEN_FILE (node->data);

		if (!kraken_file_is_local (file)) {
			parameters[i] = NULL;
			g_strfreev (parameters);
			return NULL;
		}

		file_location = kraken_file_get_location (KRAKEN_FILE (node->data));
...
get_file_paths_or_uris_as_newline_delimited_string (GList *selection, gboolean get_paths)
{
	...
	for (node = selection; node != NULL; node = node->next) {
		uri = NULL;
		if (KRAKEN_IS_DESKTOP_ICON_FILE (node->data)) {
			link = kraken_desktop_icon_file_get_link (KRAKEN_DESKTOP_ICON_FILE (node->data));
			if (link != NULL) {
			...
			uri = kraken_file_get_uri (KRAKEN_FILE (node->data));
		}
		if (uri == NULL) {
			continue;
		}
...
static void
get_strings_for_environment_variables (KrakenView *view, GList *selected_files,
				       char **file_paths, char **uris, char **uri)
{
	char *directory_uri;

	/* We need to check that the directory uri starts with "file:" since
	 * kraken_directory_is_local returns FALSE for nfs.
	 */
	directory_uri = kraken_directory_get_uri (view->details->model);
...
static KrakenView *
get_directory_view_of_extra_pane (KrakenView *view)
{
	KrakenWindowSlot *slot;
	KrakenView *next_view;

	slot = kraken_window_get_extra_slot (kraken_view_get_kraken_window (view));
	if (slot != NULL) {
		next_view = kraken_window_slot_get_current_view (slot);

		if (KRAKEN_IS_VIEW (next_view)) {
			return KRAKEN_VIEW (next_view);
		}
	}
	return NULL;
}
 ...
 * to take advantage of the current Kraken state.
 */
static void
set_script_environment_variables (KrakenView *view, GList *selected_files)
{
	char *file_paths;
	char *uris;
	char *uri;
	...
	g_setenv ("KRAKEN_SCRIPT_SELECTED_FILE_PATHS", file_paths, TRUE);
	g_free (file_paths);

	g_setenv ("KRAKEN_SCRIPT_SELECTED_URIS", uris, TRUE);
	g_free (uris);

	g_setenv ("KRAKEN_SCRIPT_CURRENT_URI", uri, TRUE);
	g_free (uri);

	geometry_string = eel_gtk_window_get_geometry_string
		(GTK_WINDOW (kraken_view_get_containing_window (view)));
	g_setenv ("KRAKEN_SCRIPT_WINDOW_GEOMETRY", geometry_string, TRUE);
	...
	if (next_view) {
		...
		next_pane_selected_files = kraken_view_get_selection (next_view);

		get_strings_for_environment_variables (next_view, next_pane_selected_files,
						       &file_paths, &uris, &uri);
		kraken_file_list_free (next_pane_selected_files);
	} else {
		file_paths = g_strdup("");
		uris = g_strdup("");
		uri = g_strdup("");
	...
	g_setenv ("KRAKEN_SCRIPT_NEXT_PANE_SELECTED_FILE_PATHS", file_paths, TRUE);
	g_free (file_paths);

	g_setenv ("KRAKEN_SCRIPT_NEXT_PANE_SELECTED_URIS", uris, TRUE);
	g_free (uris);

	g_setenv ("KRAKEN_SCRIPT_NEXT_PANE_CURRENT_URI", uri, TRUE);
	g_free (uri);
}
...
{
	g_unsetenv ("KRAKEN_SCRIPT_SELECTED_FILE_PATHS");
	g_unsetenv ("KRAKEN_SCRIPT_SELECTED_URIS");
	g_unsetenv ("KRAKEN_SCRIPT_CURRENT_URI");
	g_unsetenv ("KRAKEN_SCRIPT_WINDOW_GEOMETRY");
	g_unsetenv ("KRAKEN_SCRIPT_NEXT_PANE_SELECTED_FILE_PATHS");
	g_unsetenv ("KRAKEN_SCRIPT_NEXT_PANE_SELECTED_URIS");
	g_unsetenv ("KRAKEN_SCRIPT_NEXT_PANE_CURRENT_URI");
}
...
run_script_callback (GtkAction *action, gpointer callback_data)
{
	...
	file_uri = kraken_file_get_uri (launch_parameters->file);
	...
	selected_files = kraken_view_get_selection (launch_parameters->directory_view);
	...
	kraken_launch_application_from_command_array (screen, quoted_path, FALSE,
							(const char * const *) parameters);
	g_strfreev (parameters);

	kraken_file_list_free (selected_files);
...
static void
add_script_to_scripts_menus (KrakenView *directory_view,
			     KrakenFile *file,
			     ...
			     const char *popup_bg_path)
{
	...
	ui_manager = kraken_window_get_ui_manager (directory_view->details->window);
...
static void
add_submenu_to_directory_menus (KrakenView *directory_view,
				GtkActionGroup *action_group,
				guint merge_id,
				KrakenFile *file,
				const char *menu_path,
...
static gboolean
update_directory_in_scripts_menu (KrakenView *view, KrakenDirectory *directory)
{
	...
	g_free (uri);
	menu_path = g_strconcat (KRAKEN_VIEW_MENU_PATH_SCRIPTS_PLACEHOLDER,
				 escaped_path,
				 NULL);
	popup_path = g_strconcat (KRAKEN_VIEW_POPUP_PATH_SCRIPTS_PLACEHOLDER,
				  escaped_path,
				  NULL);
	popup_bg_path = g_strconcat (KRAKEN_VIEW_POPUP_PATH_BACKGROUND_SCRIPTS_PLACEHOLDER,
				     escaped_path,
				     NULL);
	g_free (escaped_path);

	file_list = kraken_directory_get_file_list (directory);
	filtered = kraken_file_list_filter_hidden (file_list, FALSE);
	kraken_file_list_free (file_list);

	file_list = kraken_file_list_sort_by_display_name (filtered);

	any_scripts = FALSE;
	for (node = file_list; node != NULL; node = node->next) {
		file = node->data;

		if (kraken_file_is_launchable (file) &&
            kraken_global_preferences_should_load_plugin (kraken_file_peek_name (file), KRAKEN_PLUGIN_PREFERENCES_DISABLED_SCRIPTS)) {
			add_script_to_scripts_menus (view, file, menu_path, popup_path, popup_bg_path);
			any_scripts = TRUE;
		} else if (kraken_file_is_directory (file)) {
			uri = kraken_file_get_uri (file);
...
static void
update_scripts_menu (KrakenView *view)
{
	gboolean any_scripts;
	...
	any_scripts = FALSE;
	sorted_copy = kraken_directory_list_sort_by_uri
		(kraken_directory_list_copy (view->details->scripts_directory_list));
	...
	kraken_directory_list_free (sorted_copy);

	action = gtk_action_group_get_action (view->details->dir_action_group, KRAKEN_ACTION_SCRIPTS);
	gtk_action_set_visible (action, any_scripts);
}

static void
run_action_callback (KrakenAction *action, gpointer callback_data)
{

    KrakenView *view = KRAKEN_VIEW (callback_data);
    GList *selected_files;

    selected_files = kraken_view_get_selection (view);
    KrakenFile *parent = kraken_view_get_directory_as_file (view);

    kraken_action_activate (action, selected_files, parent, GTK_WINDOW (view->details->window));

    kraken_file_list_free (selected_files);
}

static void
update_actions_visibility (KrakenView *view,
                           GList    *selection,
                           gboolean  for_accelerators)
{
    KrakenFile *parent = kraken_view_get_directory_as_file (view);

    kraken_action_manager_update_action_states (view->details->action_manager,
                                              view->details->actions_action_group,
                                              selection,
                                              parent,
                                              FALSE,
...
static void
add_action_to_ui (KrakenActionManager    *manager,
                  GtkAction            *action,
                  ...
                  gpointer              user_data)
{
    ...
    static const gchar *roots[] = {
        KRAKEN_VIEW_MENU_PATH_ACTIONS_PLACEHOLDER,
        KRAKEN_VIEW_POPUP_PATH_ACTIONS_PLACEHOLDER,
        KRAKEN_VIEW_POPUP_PATH_BACKGROUND_ACTIONS_PLACEHOLDER,
        NULL
    };

    kraken_action_manager_add_action_ui (manager,
                                       kraken_window_get_ui_manager (view->details->window),
                                       action,
                                       path,
                                       accelerator,
                                       view->details->actions_action_group,
...
static void
update_actions (KrakenView *view)
{
    DEBUG ("Refreshing menu actions");

    kraken_action_manager_iterate_actions (view->details->action_manager,
                                         (KrakenActionManagerIterFunc) add_action_to_ui,
                                         view);
...
static void
update_actions_menu (KrakenView *view)
{
    GtkUIManager *ui_manager;
...
create_template_callback (GtkAction *action, gpointer callback_data)
{
	...
	kraken_view_new_file (parameters->directory_view, NULL, parameters->file);
}

static void
add_template_to_templates_menus (KrakenView *directory_view,
				 KrakenFile *file,
				 const char *menu_path,
				 const char *popup_bg_path)
{
...
static void
update_templates_directory (KrakenView *view)
{
	KrakenDirectory *templates_directory;
	GList *node, *next;
	char *templates_uri;
...
static void
user_dirs_changed (KrakenView *view)
{
	update_templates_directory (view);
	view->details->templates_invalid = TRUE;
	schedule_update_menus (view);
...
static gboolean
update_directory_in_templates_menu (KrakenView *view,
				    ...
				    KrakenDirectory *directory)
{
	...
	g_free (uri);
	menu_path = g_strconcat (KRAKEN_VIEW_MENU_PATH_NEW_DOCUMENTS_PLACEHOLDER,
				 escaped_path,
				 NULL);
	popup_bg_path = g_strconcat (KRAKEN_VIEW_POPUP_PATH_BACKGROUND_NEW_DOCUMENTS_PLACEHOLDER,
				     escaped_path,
				     NULL);
	g_free (escaped_path);
	...
	for (node = file_list; num < TEMPLATE_LIMIT && node != NULL; node = node->next, num++) {
		...
		if (kraken_file_is_directory (file)) {
			...
			g_free (uri);
		} else if (kraken_file_can_read (file)) {
...
static void
update_templates_menu (KrakenView *view)
{
	gboolean any_templates;
	GList *sorted_copy, *node;
	KrakenDirectory *directory;
	...
	if (kraken_should_use_templates_directory ()) {
		templates_directory_uri = kraken_get_templates_directory_uri ();
	} else {
	...
	any_templates = FALSE;
	sorted_copy = kraken_directory_list_sort_by_uri
		(kraken_directory_list_copy (view->details->templates_directory_list));
	for (node = sorted_copy; node != NULL; node = node->next) {
		directory = node->data;
	...
	action = gtk_action_group_get_action (view->details->dir_action_group, KRAKEN_ACTION_NO_TEMPLATES);
...
static GtkMenu *
create_popup_menu (KrakenView *view, const char *popup_path)
{
	GtkWidget *menu;

	menu = gtk_ui_manager_get_widget (kraken_window_get_ui_manager (view->details->window),
					  popup_path);
...
static void
copy_or_cut_files (KrakenView *view,
		   ...
		   gboolean         cut)
{
    ...
    clipboard = kraken_clipboard_get (GTK_WIDGET (view));

    gtk_clipboard_set_with_data (clipboard,
                                 targets, n_targets,
                                 kraken_get_clipboard_callback, kraken_clear_clipboard_callback,
                                 NULL);
    gtk_clipboard_set_can_store (clipboard, NULL, 0);
    gtk_target_table_free (targets, n_targets);

	kraken_clipboard_monitor_set_clipboard_info (kraken_clipboard_monitor_get (), &info);

	count = g_list_length (clipboard_contents);
	if (count == 1) {
		name = kraken_file_get_display_name (clipboard_contents->data);
		if (cut) {
...
static void
move_copy_selection_to_next_pane (KrakenView *view,
				  int copy_action)
{
	KrakenWindowSlot *slot;
	char *dest_location;
	...
	dest_location = kraken_window_slot_get_current_uri (slot);
...
action_copy_to_home_callback (GtkAction *action, gpointer callback_data)
{
	...
	dest_location = kraken_get_home_directory_uri ();
...
action_copy_to_desktop_callback (GtkAction *action, gpointer callback_data)
{
	...
	dest_location = kraken_get_desktop_directory_uri ();
	move_copy_selection_to_location (view, GDK_ACTION_COPY, dest_location);
	g_free (dest_location);
}
...
static void
browse_move_to_response_cb (GtkDialog *dialog, gint response, KrakenView *view)
{
    gchar *uri;
...
static void
browse_copy_to_response_cb (GtkDialog *dialog, gint response, KrakenView *view)
{
    gchar *uri;
...
static void
paste_clipboard_data (KrakenView *view,
		      ...
		      char *destination_uri)
{
	...
	cut = FALSE;
	item_uris = kraken_clipboard_get_uri_list_from_selection_data (selection_data, &cut,
									 copied_files_atom);
	...
	if (item_uris == NULL|| destination_uri == NULL) {
		...
		kraken_view_move_copy_items (view, item_uris, NULL, destination_uri,
					       cut ? GDK_ACTION_MOVE : GDK_ACTION_COPY,
					       0, 0);

		/* If items are cut then remove from clipboard */
		if (cut) {
			gtk_clipboard_clear (kraken_clipboard_get (GTK_WIDGET (view)));
		}
				   ...
				   gpointer          data)
{
	...
	view_uri = kraken_view_get_backing_uri (view);
					...
					gpointer          callback_data)
{
	...
	if (view->details->window != NULL) {
		directory_uri = kraken_file_get_activation_uri (data->target);
			     ...
			     gpointer callback_data)
{
	...
	g_object_ref (view);
	gtk_clipboard_request_contents (kraken_clipboard_get (GTK_WIDGET (view)),
					copied_files_atom,
...
static void
paste_into (KrakenView *view,
	    KrakenFile *target)
{
	PasteIntoData *data;

	g_assert (KRAKEN_IS_VIEW (view));
	g_assert (KRAKEN_IS_FILE (target));

	data = g_new (PasteIntoData, 1);

	data->view = g_object_ref (view);
	data->target = kraken_file_ref (target);
...
static void
open_as_admin (KrakenView *view, const gchar *path) {
    ...
    kraken_window_slot_open_location (view->details->slot, location, 0);
}

static void
open_as_root (KrakenView *view, const gchar *path)
{
				  ...
				  gpointer callback_data)
{
	...
	selection = kraken_view_get_selection (view);
	if (selection != NULL) {
		paste_into (view, KRAKEN_FILE (selection->data));
		kraken_file_list_free (selection);
	}
				  ...
				  gpointer callback_data)
{
	...
	selection = kraken_view_get_selection (view);
	if (selection != NULL) {
        gchar *path = kraken_file_get_path (KRAKEN_FILE (selection->data));
		open_as_root (view, path);
		kraken_file_list_free (selection);
        g_free (path);
	} else {
        gchar *path;
        gchar *uri = kraken_view_get_uri (view);
        GFile *gfile = g_file_new_for_uri (uri);
        if (g_file_has_uri_scheme (gfile, "x-kraken-desktop")) {
            path = kraken_get_desktop_directory ();
        } else {
                                ...
                                gpointer callback_data)
{
    ...
    if (kraken_file_is_symbolic_link (selection->data)) {
        gchar *uri = kraken_file_get_symbolic_link_target_uri (selection->data);
        gchar *view_uri = kraken_view_get_uri (view);
        ...
        if (g_file_equal (current, parent)) {
            kraken_view_scroll_to_file (view, uri);
            GList *l = NULL;
            l = g_list_append (l, kraken_file_get_existing (location));
            kraken_view_set_selection (view, l);
            kraken_file_list_free (l);
        } else {
            if (get_is_desktop_view (view)) {
                kraken_mime_launch_fm_and_select_file (location);
            } else {
                kraken_window_slot_open_location (view->details->slot, location, 0);
            }
        }
                                        ...
                                        gpointer callback_data)
{
    ...
    item = KRAKEN_FILE (selection->data);
    activation_location = kraken_file_get_activation_location (item);
    activation_file = kraken_file_get (activation_location);
    location = kraken_file_get_parent (activation_file);

    kraken_view_activate_file (view, location, 0);

    kraken_file_unref (location);
    kraken_file_unref (activation_file);
				  ...
				  gpointer callback_data)
{
	...
	if (selection != NULL) {
        gchar *path;
        if (kraken_file_is_directory (KRAKEN_FILE (selection->data))) {
            path = kraken_file_get_path (KRAKEN_FILE (selection->data));
        } else {
            KrakenFile *location = kraken_file_get_parent (KRAKEN_FILE (selection->data));
            path = kraken_file_get_path (location);
            kraken_file_unref (location);
        }
...
static void
invoke_external_bulk_rename_utility (KrakenView *view,
				     GList *selection)
{
	GString *cmd;
	char *parameter;
	...
	for (walk = selection; walk; walk = walk->next) {
		file = walk->data;
		parameter = kraken_file_get_uri (file);
	...
	kraken_launch_application_from_command (gtk_widget_get_screen (GTK_WIDGET (view)),
						  cmd->str, FALSE, NULL);
	g_string_free (cmd, TRUE);
}

static void
real_action_undo (KrakenView *view)
{
	GtkWidget *toplevel;

	toplevel = gtk_widget_get_toplevel (GTK_WIDGET (view));
	kraken_file_undo_manager_undo (GTK_WINDOW (toplevel));
}

static void
real_action_redo (KrakenView *view)
{
	GtkWidget *toplevel;

	toplevel = gtk_widget_get_toplevel (GTK_WIDGET (view));
	kraken_file_undo_manager_redo (GTK_WINDOW (toplevel));
}
...
action_undo_callback (GtkAction *action,
		      gpointer callback_data)
{
	real_action_undo (KRAKEN_VIEW (callback_data));
}
...
action_redo_callback (GtkAction *action,
		      gpointer callback_data)
{
	real_action_redo (KRAKEN_VIEW (callback_data));
}

static void
real_action_rename (KrakenView *view,
		    gboolean select_all)
{
	KrakenFile *file;
	GList *selection;
	...
	if (selection_not_empty_in_menu_callback (view, selection)) {
		...
		if (selection->next != NULL) {
			...
			file = KRAKEN_FILE (selection->data);
			if (!select_all) {
				/* directories don't have a file extension, so
				 * they are always pre-selected as a whole */
				select_all = kraken_file_is_directory (file);
			}
			KRAKEN_VIEW_CLASS (G_OBJECT_GET_CLASS (view))->start_renaming_file (view, file, select_all);
		}
	}
...
action_rename_callback (GtkAction *action,
			gpointer callback_data)
{
	real_action_rename (KRAKEN_VIEW (callback_data), FALSE);
}
...
action_rename_select_all_callback (GtkAction *action,
				   gpointer callback_data)
{
	real_action_rename (KRAKEN_VIEW (callback_data), TRUE);
}

static void
file_mount_callback (KrakenFile  *file,
...
static void
file_unmount_callback (KrakenFile  *file,
		       GFile         *result_location,
		       GError        *error,
		       gpointer       callback_data)
{
...
static void
file_eject_callback (KrakenFile  *file,
		     GFile         *result_location,
		     GError        *error,
		     gpointer       callback_data)
{
...
static void
file_stop_callback (KrakenFile  *file,
		    GFile         *result_location,
		    GError        *error,
		    gpointer       callback_data)
{
			      ...
			      gpointer data)
{
	...
	for (l = selection; l != NULL; l = l->next) {
		...
		if (kraken_file_can_mount (file)) {
			mount_op = gtk_mount_operation_new (kraken_view_get_containing_window (view));
			g_mount_operation_set_password_save (mount_op, G_PASSWORD_SAVE_FOR_SESSION);
			kraken_file_mount (file, mount_op, NULL,
				...
				gpointer data)
{
	...
	for (l = selection; l != NULL; l = l->next) {
		file = KRAKEN_FILE (l->data);
		if (kraken_file_can_unmount (file)) {
			GMountOperation *mount_op;
			mount_op = gtk_mount_operation_new (kraken_view_get_containing_window (view));
			kraken_file_unmount (file, mount_op, NULL,
			      ...
			      gpointer data)
{
	...
	for (l = selection; l != NULL; l = l->next) {
		...
		if (kraken_file_can_eject (file)) {
			GMountOperation *mount_op;
			mount_op = gtk_mount_operation_new (kraken_view_get_containing_window (view));
			kraken_file_eject (file, mount_op, NULL,
...
static void
file_start_callback (KrakenFile  *file,
		     GFile         *result_location,
		     GError        *error,
		     gpointer       callback_data)
{
			      ...
			      gpointer   data)
{
	...
	for (l = selection; l != NULL; l = l->next) {
		...
		if (kraken_file_can_start (file) || kraken_file_can_start_degraded (file)) {
			mount_op = gtk_mount_operation_new (kraken_view_get_containing_window (view));
			kraken_file_start (file, mount_op, NULL,
			     ...
			     gpointer   data)
{
	...
	for (l = selection; l != NULL; l = l->next) {
		...
		if (kraken_file_can_stop (file)) {
			GMountOperation *mount_op;
			mount_op = gtk_mount_operation_new (kraken_view_get_containing_window (view));
			kraken_file_stop (file, mount_op, NULL,
			      ...
			      gpointer   data)
{
	...
	for (l = selection; l != NULL; l = l->next) {
		...
		if (kraken_file_can_poll_for_media (file) && !kraken_file_is_media_check_automatic (file)) {
			kraken_file_poll_for_media (file);
		}
	}
	kraken_file_list_free (selection);
}
				   ...
				   gpointer data)
{
	...
	mount_op = gtk_mount_operation_new (kraken_view_get_containing_window (view));
	g_mount_operation_set_password_save (mount_op, G_PASSWORD_SAVE_FOR_SESSION);
	kraken_file_mount (file, mount_op, NULL, file_mount_callback, NULL);
	g_object_unref (mount_op);
}
				     ...
				     gpointer data)
{
	...
	mount_op = gtk_mount_operation_new (kraken_view_get_containing_window (view));
	kraken_file_unmount (file, mount_op, NULL, file_unmount_callback, g_object_ref (view));
	g_object_unref (mount_op);
}
				   ...
				   gpointer data)
{
	...
	mount_op = gtk_mount_operation_new (kraken_view_get_containing_window (view));
	kraken_file_eject (file, mount_op, NULL, file_eject_callback, g_object_ref (view));
	g_object_unref (mount_op);
}
				   ...
				   gpointer   data)
{
	...
	mount_op = gtk_mount_operation_new (kraken_view_get_containing_window (view));
	kraken_file_start (file, mount_op, NULL, file_start_callback, NULL);
	g_object_unref (mount_op);
}
					...
					gpointer data)
{
	...
	uri = kraken_file_get_activation_uri (file);
	icon = kraken_file_get_icon (file, KRAKEN_ICON_SIZE_STANDARD, 0, gtk_widget_get_scale_factor (GTK_WIDGET (view)), 0);
	icon_name = kraken_icon_info_get_used_name (icon);
	name = kraken_file_get_display_name (file);
					 ...
					 gpointer   callback_data)
{
	...
	kraken_view_activate_file (view,
				     file,
				     KRAKEN_WINDOW_OPEN_FLAG_NEW_WINDOW);
}
				 ...
				 gpointer   callback_data)
{
	...
	kraken_file_operations_delete (files, kraken_view_get_containing_window (view),
					 NULL, NULL);
					     ...
					     gpointer callback_data)
{
	...
	l.next = NULL;
	l.data = file;
	kraken_restore_files_from_trash (&l,
					   kraken_view_get_containing_window (view));
}

static void
kraken_view_init_show_hidden_files (KrakenView *view)
{
	...
	mode = kraken_window_get_hidden_files_mode (view->details->window);

    if (mode == KRAKEN_WINDOW_SHOW_HIDDEN_FILES_ENABLE) {
...
static const GtkActionEntry directory_view_entries[] = {
  ...
  /* name, stock id */         { KRAKEN_ACTION_OPEN_IN_TERMINAL, "xsi-utilities-terminal-symbolic",
  ...
  /* name, stock id */         { KRAKEN_ACTION_OPEN_AS_ROOT, "xsi-dialog-password-symbolic",
  ...
  /* name, stock id */         { KRAKEN_ACTION_FOLLOW_SYMLINK, "xsi-go-jump-symbolic",
  ...
  /* name, stock id */         { KRAKEN_ACTION_OPEN_CONTAINING_FOLDER, "xsi-go-jump-symbolic",
 ...
 /* tooltip */                   N_("Redo the last undone action"),
  ...
  /* name, stock id */         { KRAKEN_ACTION_LOCATION_OPEN_ALTERNATE, NULL,
  ...
  /* name, stock id */         { KRAKEN_ACTION_LOCATION_OPEN_IN_NEW_TAB, NULL,
  ...
  /* name, stock id */         { KRAKEN_ACTION_LOCATION_CUT, "xsi-edit-cut-symbolic",
  ...
  /* name, stock id */         { KRAKEN_ACTION_LOCATION_COPY, "xsi-edit-copy-symbolic",
  ...
  /* name, stock id */         { KRAKEN_ACTION_LOCATION_PASTE_FILES_INTO, "xsi-edit-paste-symbolic",
  /* label, accelerator */       N_("_Paste Into Folder"), "",
  ...
  /* name, stock id */         { KRAKEN_ACTION_LOCATION_RESTORE_FROM_TRASH, NULL,
...
static void
connect_proxy (KrakenView *view,
               GtkAction *action,
               GtkWidget *proxy,
               GtkActionGroup *action_group)
{
    if (strcmp (gtk_action_get_name (action), KRAKEN_ACTION_NEW_EMPTY_DOCUMENT) == 0 &&
...
real_merge_menus (KrakenView *view)
{
	...
	action = gtk_action_group_get_action (action_group, KRAKEN_ACTION_NO_TEMPLATES);
    ...
    view->details->dir_merge_id = gtk_ui_manager_add_ui_from_resource (ui_manager, "/org/kraken/kraken-directory-view-ui.xml", NULL);
...
static gboolean
can_paste_into_file (KrakenFile *file)
{
	if (kraken_file_is_directory (file) &&
	    kraken_file_can_write (file)) {
		return TRUE;
	}
	if (kraken_file_has_activation_uri (file)) {
		GFile *location;
		KrakenFile *activation_file;
		gboolean res;

		location = kraken_file_get_activation_location (file);
		activation_file = kraken_file_get (location);
		g_object_unref (location);

		/* The target location might not have data for it read yet,
		   and we can't want to do sync I/O, so treat the unknown
		   case as can-write */
		res = (kraken_file_get_file_type (activation_file) == G_FILE_TYPE_UNKNOWN) ||
			(kraken_file_get_file_type (activation_file) == G_FILE_TYPE_DIRECTORY &&
			 kraken_file_can_write (activation_file));
			    ...
			    gpointer          user_data)
{
	...
	gtk_action_set_sensitive (action,
				  can_paste && !kraken_view_is_read_only (view));

	action = gtk_action_group_get_action (view->details->dir_action_group,
					      KRAKEN_ACTION_PASTE_FILES_INTO);
	gtk_action_set_sensitive (action,
	                          can_paste && count == 1 &&
	                          can_paste_into_file (KRAKEN_FILE (selection->data)));

	action = gtk_action_group_get_action (view->details->dir_action_group,
					      KRAKEN_ACTION_LOCATION_PASTE_FILES_INTO);
...
static gboolean
should_show_empty_trash (KrakenView *view)
{
...
file_list_all_are_folders (GList *file_list)
{
	...
	for (l = file_list; l != NULL; l = l->next) {
		...
		if (kraken_file_is_kraken_link (file) &&
		    !KRAKEN_IS_DESKTOP_ICON_FILE (file)) {
			if (kraken_file_is_launcher (file)) {
				return FALSE;
			}

			activation_uri = kraken_file_get_activation_uri (file);
			...
			linked_file = kraken_file_get_existing_by_uri (activation_uri);
			...
			is_dir =
				(linked_file != NULL &&
				 kraken_file_is_directory (linked_file)) ||
				(activation_uri != NULL &&
				 activation_uri[strlen (activation_uri) - 1] == '/');

			kraken_file_unref (linked_file);
			g_free (activation_uri);
...
static void
file_should_show_foreach (KrakenFile        *file,
			  gboolean            *show_mount,
			  ...
			  GDriveStartStopType *start_stop_type)
{
	...
	*show_poll = FALSE;
	...
	if (kraken_file_can_unmount (file) && !*show_eject && !*show_stop) {
		*show_unmount = TRUE;
	}
	...
	*start_stop_type = kraken_file_get_start_stop_type (file);
...
static void
file_should_show_self (KrakenFile        *file,
		       gboolean            *show_mount,
		       gboolean            *show_unmount,
		       gboolean            *show_eject,
		       gboolean            *show_start,
...
files_are_all_directories (GList *files)
{
	...
	for (l = files; l != NULL; l = l->next) {
		file = KRAKEN_FILE (l->data);
		all_directories &= kraken_file_is_directory (file);
	}
...
files_is_none_directory (GList *files)
{
	...
	for (l = files; l != NULL; l = l->next) {
		file = KRAKEN_FILE (l->data);
		no_directory &= !kraken_file_is_directory (file);
	}
				  ...
				  gboolean is_self)
{
	...
	if (files != NULL) {
		if (g_list_length (files) == 1) {
			original_file = kraken_file_get_trash_original_file (files->data);
		} else {
			original_dirs_hash = kraken_trashed_files_get_original_directories (files, NULL);
			if (original_dirs_hash != NULL) {
				original_dirs = g_hash_table_get_keys (original_dirs_hash);
				if (g_list_length (original_dirs) == 1) {
					original_dir = kraken_file_ref (KRAKEN_FILE (original_dirs->data));
				}
			}
		}
	}
	...
	if (original_file != NULL || original_dirs != NULL) {
		...
		if (original_file != NULL) {
			original_location = kraken_file_get_location (original_file);
		} else if (original_dir != NULL) {
			original_location = kraken_file_get_location (original_dir);
		}
	...
	kraken_file_unref (original_file);
	kraken_file_unref (original_dir);
...
static void
real_update_menus_volumes (KrakenView *view,
			   GList *selection,
			   gint selection_count)
{
	...
	action = gtk_action_group_get_action (view->details->dir_action_group,
					      KRAKEN_ACTION_SELF_STOP_VOLUME);
	...
	action = gtk_action_group_get_action (view->details->dir_action_group,
					      KRAKEN_ACTION_SELF_POLL);
	gtk_action_set_visible (action, show_self_poll);

}

static void
real_update_location_menu_volumes (KrakenView *view)
{
	GtkAction *action;
	KrakenFile *file;
	gboolean show_mount;
	...
	file = KRAKEN_FILE (view->details->location_popup_directory_as_file);
	file_should_show_foreach (file,
				  &show_mount,
				  &show_unmount,
				  &show_eject,
	...
	action = gtk_action_group_get_action (view->details->dir_action_group,
					      KRAKEN_ACTION_LOCATION_MOUNT_VOLUME);
	gtk_action_set_visible (action, show_mount);

	action = gtk_action_group_get_action (view->details->dir_action_group,
					      KRAKEN_ACTION_LOCATION_UNMOUNT_VOLUME);
	gtk_action_set_visible (action, show_unmount);

	action = gtk_action_group_get_action (view->details->dir_action_group,
					      KRAKEN_ACTION_LOCATION_EJECT_VOLUME);
	gtk_action_set_visible (action, show_eject);

	action = gtk_action_group_get_action (view->details->dir_action_group,
					      KRAKEN_ACTION_LOCATION_START_VOLUME);
	gtk_action_set_visible (action, show_start);
	if (show_start) {
		switch (start_stop_type) {
		default:
	...
	action = gtk_action_group_get_action (view->details->dir_action_group,
					      KRAKEN_ACTION_LOCATION_STOP_VOLUME);
	gtk_action_set_visible (action, show_stop);
	if (show_stop) {
		switch (start_stop_type) {
		default:
 ...
 */
static void
real_update_paste_menu (KrakenView *view,
			GList *selection,
			gint selection_count)
{
	...
	selection_is_read_only = selection_count == 1 &&
		(!kraken_file_can_write (KRAKEN_FILE (selection->data)) &&
		 !kraken_file_has_activation_uri (KRAKEN_FILE (selection->data)));

	is_read_only = kraken_view_is_read_only (view);
	...
	gtk_clipboard_request_targets (kraken_clipboard_get (GTK_WIDGET (view)),
				       clipboard_targets_received,
				       view);
}

static void
real_update_location_menu (KrakenView *view)
{
	GtkAction *action;
	KrakenFile *file;
	...
	show_open_in_new_tab = g_settings_get_boolean (kraken_preferences, KRAKEN_PREFERENCES_ALWAYS_USE_BROWSER);
	show_open_alternate = g_settings_get_boolean (kraken_preferences, KRAKEN_PREFERENCES_ALWAYS_USE_BROWSER);

	action = gtk_action_group_get_action (view->details->dir_action_group,
					      KRAKEN_ACTION_LOCATION_OPEN_ALTERNATE);
	...
	action = gtk_action_group_get_action (view->details->dir_action_group,
					      KRAKEN_ACTION_LOCATION_OPEN_IN_NEW_TAB);
	...
	file = view->details->location_popup_directory_as_file;
	g_assert (KRAKEN_IS_FILE (file));
	g_assert (kraken_file_check_if_ready (file, KRAKEN_FILE_ATTRIBUTE_INFO |
						KRAKEN_FILE_ATTRIBUTE_MOUNT |
						KRAKEN_FILE_ATTRIBUTE_FILESYSTEM_INFO));

	is_special_link = KRAKEN_IS_DESKTOP_ICON_FILE (file);
	is_desktop_or_home_dir = kraken_file_is_home (file)
		|| kraken_file_is_desktop_directory (file);

    is_recent = kraken_file_is_in_recent (file);

	can_delete_file =
		kraken_file_can_delete (file) &&
		!is_special_link &&
		!is_desktop_or_home_dir;

	action = gtk_action_group_get_action (view->details->dir_action_group,
					      KRAKEN_ACTION_LOCATION_CUT);
	...
	if (file != NULL &&
		...
		show_separate_delete_command = g_settings_get_boolean (kraken_preferences, KRAKEN_PREFERENCES_ENABLE_DELETE);
	}

	action = gtk_action_group_get_action (view->details->dir_action_group,
					      KRAKEN_ACTION_LOCATION_TRASH);
	g_object_set (action,
		      "label", label,
		      "tooltip", tip,
		      "icon-name", (file != NULL &&
				    kraken_file_is_in_trash (file)) ?
		      KRAKEN_ICON_DELETE : KRAKEN_ICON_SYMBOLIC_TRASH_FULL,
		      NULL);
	gtk_action_set_sensitive (action, can_delete_file);
	gtk_action_set_visible (action, show_delete);

	action = gtk_action_group_get_action (view->details->dir_action_group,
					      KRAKEN_ACTION_LOCATION_DELETE);
	gtk_action_set_visible (action, show_separate_delete_command);
	if (show_separate_delete_command) {
		gtk_action_set_sensitive (action, can_delete_file);
		g_object_set (action,
			      "icon-name", KRAKEN_ICON_DELETE,
			      "sensitive", can_delete_file,
			      NULL);
	}

	action = gtk_action_group_get_action (view->details->dir_action_group,
					      KRAKEN_ACTION_LOCATION_RESTORE_FROM_TRASH);
	l.prev = NULL;
	l.next = NULL;
	l.data = file;
...
static void
clipboard_changed_callback (KrakenClipboardMonitor *monitor, KrakenView *view)
{
	GList *selection;
	gint selection_count;
...
can_delete_all (GList *files)
{
	...
	for (l = files; l != NULL; l = l->next) {
		file = l->data;
		if (!kraken_file_can_delete (file)) {
			return FALSE;
		}
	}
	return TRUE;
...
static gboolean
has_writable_extra_pane (KrakenView *view)
{
	KrakenView *other_view;

	other_view = get_directory_view_of_extra_pane (view);
	if (other_view != NULL) {
		return !kraken_view_is_read_only (other_view);
	}
	return FALSE;
}

static void
update_configurable_context_menu_items (KrakenView *view)
{
    GtkUIManager *ui_manager;
    GtkWidget *item;
    GtkAction *action;
    ...
    for (i = 0; i < CONFIGURABLE_MENU_ITEM_COUNT; i++) {
        ...
        gboolean pref_visible = g_settings_get_boolean (kraken_menu_config_preferences,
...
real_update_menus (KrakenView *view)
{
	...
	can_create_files = kraken_view_supports_creating_files (view);
	can_delete_files =
    ...
    if (selection_count > 1) {
        ...
        for (ptr = selection; ptr != NULL; ptr = ptr->next) {
            KrakenFile *item = KRAKEN_FILE (ptr->data);
            // Favorites can be renamed, but only one at a time - bulk renamers don't know about the
            // xapp favorites api.
            if (!kraken_view_can_rename_file (view, item) || kraken_file_is_in_favorites (item)) {
                can_rename = FALSE;
                break;
            }
        }
		...
		gtk_action_set_sensitive (action,
					  selection_count == 1 &&
					  kraken_view_can_rename_file (view, selection->data));
	}
    ...
    action = gtk_action_group_get_action (view->details->dir_action_group,
                                         KRAKEN_ACTION_OPEN_AS_ROOT);
    gtk_action_set_visible (action, (!(kraken_user_is_root () || showing_admin_enabled_directory (view))) && no_selection_or_one_dir);

    action = gtk_action_group_get_action (view->details->dir_action_group,
                                         KRAKEN_ACTION_OPEN_IN_TERMINAL);
	...
	for (l = selection; l != NULL; l = l->next) {
		...
		if (!kraken_mime_file_opens_in_external_app (file)) {
			show_app = FALSE;
		}
	...
	if (can_open && show_app) {
		app = kraken_mime_get_default_application_for_files (selection);
	}
    ...
    menu_item_show_image (kraken_window_get_ui_manager (view->details->window),
                          KRAKEN_VIEW_MENU_PATH_OPEN_PLACEHOLDER,
                          KRAKEN_ACTION_OPEN,
                          FALSE);

	show_open_alternate = file_list_all_are_folders (selection) &&
		selection_count > 0 &&
		g_settings_get_boolean (kraken_preferences, KRAKEN_PREFERENCES_ALWAYS_USE_BROWSER) &&
		!is_desktop_view;

	action = gtk_action_group_get_action (view->details->dir_action_group,
					      KRAKEN_ACTION_OPEN_ALTERNATE);
	...
	action = gtk_action_group_get_action (view->details->dir_action_group,
					      KRAKEN_ACTION_RESTORE_FROM_TRASH);
	update_restore_from_trash_action (action, selection, FALSE);

	action = gtk_action_group_get_action (view->details->dir_action_group, KRAKEN_ACTION_DUPLICATE);
	gtk_action_set_sensitive (action, can_duplicate_files);
    gtk_action_set_visible (action, !selection_contains_recent && !selection_contains_favorites);

	action = gtk_action_group_get_action (view->details->dir_action_group,
					      KRAKEN_ACTION_CREATE_LINK);
	...
	action = gtk_action_group_get_action (view->details->dir_action_group,
					      KRAKEN_ACTION_PROPERTIES_ACCEL);

	gtk_action_set_sensitive (action, show_properties);

	action = gtk_action_group_get_action (view->details->dir_action_group,
					      KRAKEN_ACTION_EMPTY_TRASH);
	g_object_set (action,
    ...
    showing_search = view->details->model && KRAKEN_IS_SEARCH_DIRECTORY (view->details->model);

	action = gtk_action_group_get_action (view->details->dir_action_group,
					      KRAKEN_ACTION_SELECT_ALL);
	gtk_action_set_sensitive (action, !kraken_view_is_empty (view));

	action = gtk_action_group_get_action (view->details->dir_action_group,
					      KRAKEN_ACTION_SELECT_PATTERN);
	gtk_action_set_sensitive (action, !kraken_view_is_empty (view));

	action = gtk_action_group_get_action (view->details->dir_action_group,
					      KRAKEN_ACTION_INVERT_SELECTION);
	gtk_action_set_sensitive (action, !kraken_view_is_empty (view));
	...
	action = gtk_action_group_get_action (view->details->dir_action_group,
					      KRAKEN_ACTION_COPY_TO_NEXT_PANE);
	...
	action = gtk_action_group_get_action (view->details->dir_action_group,
					      KRAKEN_ACTION_MOVE_TO_NEXT_PANE);
	...
	show_desktop_target =
		g_settings_get_boolean (kraken_desktop_preferences, KRAKEN_PREFERENCES_SHOW_DESKTOP) &&
		!g_settings_get_boolean (kraken_preferences, KRAKEN_PREFERENCES_DESKTOP_IS_HOME_DIR);

	action = gtk_action_group_get_action (view->details->dir_action_group,
					      KRAKEN_ACTION_COPY_TO_HOME);
	gtk_action_set_sensitive (action, can_copy_files);

	action = gtk_action_group_get_action (view->details->dir_action_group,
					      KRAKEN_ACTION_COPY_TO_DESKTOP);
	gtk_action_set_sensitive (action, can_copy_files);
	gtk_action_set_visible (action, show_desktop_target);

	action = gtk_action_group_get_action (view->details->dir_action_group,
					      KRAKEN_ACTION_MOVE_TO_HOME);
	gtk_action_set_sensitive (action, can_delete_files);
    gtk_action_set_visible (action, !selection_contains_recent && !selection_contains_favorites);
	action = gtk_action_group_get_action (view->details->dir_action_group,
					      KRAKEN_ACTION_MOVE_TO_DESKTOP);
	gtk_action_set_sensitive (action, can_delete_files);
	gtk_action_set_visible (action, show_desktop_target &&
                            !selection_contains_recent &&
                            !selection_contains_favorites);
    ...
    action = gtk_action_group_get_action (view->details->dir_action_group,
                                          KRAKEN_ACTION_FOLLOW_SYMLINK);
    gtk_action_set_visible (action,
                            selection_count == 1 &&
                            kraken_file_is_symbolic_link (selection->data) &&
                            !selection_contains_favorites);

    action = gtk_action_group_get_action (view->details->dir_action_group,
                                          KRAKEN_ACTION_OPEN_CONTAINING_FOLDER);
    ...
    first_selected_is_pinned = selection_count > 0 &&
                               kraken_file_get_pinning (KRAKEN_FILE (selection->data));

    action = gtk_action_group_get_action (view->details->dir_action_group,
                                          KRAKEN_ACTION_PIN_FILE);
    ...
    action = gtk_action_group_get_action (view->details->dir_action_group,
                                          KRAKEN_ACTION_UNPIN_FILE);

    gtk_action_set_visible (action, selection_count > 0 && !is_desktop_view && first_selected_is_pinned &&
                                    !(selection_contains_recent || selection_contains_favorites || selection_contains_trash));

    action = gtk_action_group_get_action (view->details->dir_action_group,
                                          KRAKEN_ACTION_FAVORITE_FILE);

    gboolean first_selected_is_favorite = selection_count > 0 &&
                                          kraken_file_get_is_favorite (KRAKEN_FILE (selection->data));
...
void
kraken_view_update_actions_and_extensions (KrakenView *view)
{
    GList *selection;
...
static void
update_accelerated_actions (KrakenView *view)
{
    GList *selection;
 ...
 **/
void
kraken_view_pop_up_selection_context_menu  (KrakenView *view,
					      GdkEventButton  *event)
{
	g_assert (KRAKEN_IS_VIEW (view));
    ...
    eel_pop_up_context_menu (create_popup_menu (view, KRAKEN_VIEW_POPUP_PATH_SELECTION),
                             (GdkEvent *) event,
                             GTK_WIDGET (view));
}
 ...
 **/
void
kraken_view_pop_up_background_context_menu (KrakenView *view,
					      GdkEventButton  *event)
{
	g_assert (KRAKEN_IS_VIEW (view));
	...
	eel_pop_up_context_menu (create_popup_menu
				 (view, KRAKEN_VIEW_POPUP_PATH_BACKGROUND),
				 (GdkEvent *) event,
                 GTK_WIDGET (view));
}

static void
real_pop_up_location_context_menu (KrakenView *view)
{
	...
	eel_pop_up_context_menu (create_popup_menu
				 (view, KRAKEN_VIEW_POPUP_PATH_LOCATION),
				 (GdkEvent *) view->details->location_popup_event,
                 GTK_WIDGET (view));
}

static void
location_popup_file_attributes_ready (KrakenFile *file,
				      gpointer      data)
{
	KrakenView *view;
...
static void
unschedule_pop_up_location_context_menu (KrakenView *view)
{
	if (view->details->location_popup_directory_as_file != NULL) {
		g_assert (KRAKEN_IS_FILE (view->details->location_popup_directory_as_file));
		kraken_file_cancel_call_when_ready (view->details->location_popup_directory_as_file,
						      location_popup_file_attributes_ready,
						      view);
		kraken_file_unref (view->details->location_popup_directory_as_file);
		view->details->location_popup_directory_as_file = NULL;
	}
}

static void
schedule_pop_up_location_context_menu (KrakenView *view,
				       GdkEventButton  *event,
				       KrakenFile    *file)
{
	g_assert (KRAKEN_IS_FILE (file));
	...
	if (file == view->details->location_popup_directory_as_file) {
		if (kraken_file_check_if_ready (file, KRAKEN_FILE_ATTRIBUTE_INFO |
						  KRAKEN_FILE_ATTRIBUTE_MOUNT |
						  KRAKEN_FILE_ATTRIBUTE_FILESYSTEM_INFO)) {
			real_pop_up_location_context_menu (view);
		}
		...
		view->details->location_popup_directory_as_file = kraken_file_ref (file);
		kraken_file_call_when_ready (view->details->location_popup_directory_as_file,
					       KRAKEN_FILE_ATTRIBUTE_INFO |
					       KRAKEN_FILE_ATTRIBUTE_MOUNT |
					       KRAKEN_FILE_ATTRIBUTE_FILESYSTEM_INFO,
					       location_popup_file_attributes_ready,
 ...
 **/
void
kraken_view_pop_up_location_context_menu (KrakenView *view,
					    GdkEventButton  *event,
					    const char      *location)
{
	KrakenFile *file;
	...
	if (location != NULL) {
		file = kraken_file_get_by_uri (location);
	} else {
		file = kraken_file_ref (view->details->directory_as_file);
	}
...
static void
real_schedule_update_menus (KrakenView *view, guint update_interval)
{
...
static void
schedule_update_menus (KrakenView *view)
{
    g_assert (KRAKEN_IS_VIEW (view));
...
static void
selection_changed_schedule_update_menus (KrakenView *view)
{
    g_assert (KRAKEN_IS_VIEW (view));
...
static void
remove_update_status_idle_callback (KrakenView *view)
{
...
static void
schedule_update_status (KrakenView *view)
{
	g_assert (KRAKEN_IS_VIEW (view));
...
/**
 * kraken_view_notify_selection_changed:
 *
 * Notify this view that the selection has changed. This is normally
 * called only by subclasses.
 * @view: KrakenView whose selection has changed.
 *
 **/
void
kraken_view_notify_selection_changed (KrakenView *view)
{
	GtkWindow *window;
	GList *selection;
    ...
    if (view->details->display_selection_idle_id != 0) {
        g_source_remove (view->details->display_selection_idle_id);
        view->details->display_selection_idle_id = 0;
        kraken_window_slot_set_status (view->details->slot, "", "", view->details->loading);
    }
...
static void
file_changed_callback (KrakenFile *file, gpointer callback_data)
{
	KrakenView *view = KRAKEN_VIEW (callback_data);
 ...
 * @view: KrakenView whose location will be changed.
 * @uri: A string representing the uri to switch to.
 *
 **/
static void
load_directory (KrakenView *view,
		KrakenDirectory *directory)
{
	...
	view->details->directory_as_file =
		kraken_directory_get_corresponding_file (directory);
	kraken_file_unref (old_file);
	...
	kraken_file_call_when_ready
		(view->details->directory_as_file,
		 attributes,
		 metadata_for_directory_as_file_ready_callback, view);
	kraken_directory_call_when_ready
		(view->details->model,
		 attributes,
		 FALSE,
	...
	attributes =
		KRAKEN_FILE_ATTRIBUTE_INFO |
		KRAKEN_FILE_ATTRIBUTE_FILESYSTEM_INFO;
	kraken_file_monitor_add (view->details->directory_as_file,
				   &view->details->directory_as_file,
				   attributes);
...
static void
finish_loading (KrakenView *view)
{
	KrakenFileAttributes attributes;

	kraken_window_report_load_underway (view->details->window,
					      KRAKEN_VIEW (view));
	...
	kraken_window_view_visible  (view->details->window, KRAKEN_VIEW (view));

	if (kraken_directory_are_all_files_seen (view->details->model)) {
		/* Unschedule a pending update and schedule a new one with the minimal
		 * update interval. This gives the view a short chance at gathering the
		 * (cached) deep counts.
		 */
	...
	kraken_directory_file_monitor_add (view->details->model,
					     &view->details->model,
					     view->details->show_hidden_files,
					     attributes,
					     files_added_callback, view);
...
static void
finish_loading_if_all_metadata_loaded (KrakenView *view)
{
...
static void
metadata_for_directory_as_file_ready_callback (KrakenFile *file,
			      		       gpointer callback_data)
{
	KrakenView *view;
...
static void
metadata_for_files_in_directory_ready_callback (KrakenDirectory *directory,
				   		GList *files,
			           		gpointer callback_data)
{
	KrakenView *view;
...
static void
disconnect_directory_handler (KrakenView *view, guint *id)
{
	disconnect_handler (G_OBJECT (view->details->model), id);
}

static void
disconnect_directory_as_file_handler (KrakenView *view, guint *id)
{
	disconnect_handler (G_OBJECT (view->details->directory_as_file), id);
}

static void
disconnect_model_handlers (KrakenView *view)
{
	if (view->details->model == NULL) {
		return;
	}
	...
	kraken_file_cancel_call_when_ready (view->details->directory_as_file,
					      metadata_for_directory_as_file_ready_callback,
					      view);
	kraken_directory_cancel_callback (view->details->model,
					    metadata_for_files_in_directory_ready_callback,
					    view);
	kraken_directory_file_monitor_remove (view->details->model,
						&view->details->model);
	kraken_file_monitor_remove (view->details->directory_as_file,
				      &view->details->directory_as_file);
}

static void
kraken_view_select_file (KrakenView *view, KrakenFile *file)
{
	GList file_list;
	...
	file_list.next = NULL;
	file_list.prev = NULL;
	kraken_view_call_set_selection (view, &file_list);
}

/**
 * kraken_view_stop_loading:
 *
 ...
 **/
void
kraken_view_stop_loading (KrakenView *view)
{
	g_return_if_fail (KRAKEN_IS_VIEW (view));
	...
	if (view->details->model != NULL) {
		kraken_directory_file_monitor_remove (view->details->model, view);
	}
	done_loading (view, FALSE);
}

gboolean
kraken_view_is_editable (KrakenView *view)
{
	KrakenDirectory *directory;
	...
	if (directory != NULL) {
		return kraken_directory_is_editable (directory);
	}
...
static gboolean
real_is_read_only (KrakenView *view)
{
	KrakenFile *file;
	...
	if (!kraken_view_is_editable (view)) {
		return TRUE;
	}
    ...
    if (file != NULL) {
        if (kraken_file_is_in_admin (file)) {
            return TRUE;
        }

        return !kraken_file_can_write (file);
    }
...
/**
 * kraken_view_should_show_file
 *
 * Returns whether or not this file should be displayed based on
 * current filtering options.
 */
gboolean
kraken_view_should_show_file (KrakenView *view, KrakenFile *file)
{
...
static gboolean
real_using_manual_layout (KrakenView *view)
{
	g_return_val_if_fail (KRAKEN_IS_VIEW (view), FALSE);
...
{
	schedule_update_menus (KRAKEN_VIEW (callback_data));
}

void
kraken_view_ignore_hidden_file_preferences (KrakenView *view)
{
...
void
kraken_view_set_show_foreign (KrakenView *view,
...
char *
kraken_view_get_uri (KrakenView *view)
{
	g_return_val_if_fail (KRAKEN_IS_VIEW (view), NULL);
	if (view->details->model == NULL) {
		return NULL;
	}
	return kraken_directory_get_uri (view->details->model);
}

void
kraken_view_move_copy_items (KrakenView *view,
			       ...
			       int x, int y)
{
	...
	target_file = kraken_file_get_existing_by_uri (target_uri);
	/* special-case "command:" here instead of starting a move/copy */
	if (target_file != NULL && kraken_file_is_launcher (target_file)) {
		kraken_file_unref (target_file);
		kraken_launch_desktop_file (
					      gtk_widget_get_screen (GTK_WIDGET (view)),
					      target_uri, item_uris,
					      kraken_view_get_containing_window (view));
		return;
	} else if (copy_action == GDK_ACTION_COPY &&
		   kraken_is_file_roller_installed () &&
		   target_file != NULL &&
		   kraken_file_is_archive (target_file)) {
		...
		kraken_launch_application_from_command (screen, command, FALSE, NULL);
		g_free (command);
	...
	kraken_file_operations_copy_move
...
static void
kraken_view_trash_state_changed_callback (KrakenTrashMonitor *trash_monitor,
					    gboolean state, gpointer callback_data)
{
	KrakenView *view;

	view = (KrakenView *) callback_data;
	g_assert (KRAKEN_IS_VIEW (view));
...
void
kraken_view_start_batching_selection_changes (KrakenView *view)
{
	g_return_if_fail (KRAKEN_IS_VIEW (view));
...
void
kraken_view_stop_batching_selection_changes (KrakenView *view)
{
	g_return_if_fail (KRAKEN_IS_VIEW (view));
...
gboolean
kraken_view_get_active (KrakenView *view)
{
	g_assert (KRAKEN_IS_VIEW (view));
...
static GArray *
real_get_selected_icon_locations (KrakenView *view)
{
...
static void
kraken_view_set_property (GObject         *object,
			    guint            prop_id,
			    const GValue    *value,
			    GParamSpec      *pspec)
{
	...
	directory_view = KRAKEN_VIEW (object);

	switch (prop_id)  {
	case PROP_WINDOW_SLOT:
		g_assert (directory_view->details->slot == NULL);

		slot = KRAKEN_WINDOW_SLOT (g_value_get_object (value));
...
gboolean
kraken_view_handle_scroll_event (KrakenView *directory_view,
				   GdkEventScroll *event)
{
	...
	if (event->state & GDK_CONTROL_MASK) {
		...
		case GDK_SCROLL_UP:
			/* Zoom In */
			kraken_view_bump_zoom_level (directory_view, 1);
			return TRUE;
...
static gboolean
kraken_view_scroll_event (GtkWidget *widget,
			    GdkEventScroll *event)
{
	KrakenView *directory_view;

	directory_view = KRAKEN_VIEW (widget);
    if (!get_is_desktop_view (directory_view) &&
        kraken_view_handle_scroll_event (directory_view, event)) {
		return TRUE;
	}
...
static void
kraken_view_parent_set (GtkWidget *widget,
			  GtkWidget *old_parent)
{
	...
	if (parent != NULL) {
		...
		if (view->details->slot ==
		    kraken_window_get_active_slot (view->details->window)) {
			view->details->active = TRUE;
...
static void
kraken_view_class_init (KrakenViewClass *klass)
{
	GObjectClass *oclass;
	...
	oclass->finalize = kraken_view_finalize;
	oclass->set_property = kraken_view_set_property;

	widget_class->destroy = kraken_view_destroy;
	widget_class->scroll_event = kraken_view_scroll_event;
	widget_class->parent_set = kraken_view_parent_set;

	g_type_class_add_private (klass, sizeof (KrakenViewDetails));
	...
	signals[ADD_FILE] =
		g_signal_new ("add_file",
		              ...
		              G_SIGNAL_RUN_LAST,
		              G_STRUCT_OFFSET (KrakenViewClass, add_file),
		              NULL, NULL,
		              g_cclosure_marshal_generic,
		              G_TYPE_NONE, 2, KRAKEN_TYPE_FILE, KRAKEN_TYPE_DIRECTORY);
	signals[BEGIN_FILE_CHANGES] =
		g_signal_new ("begin_file_changes",
		              G_TYPE_FROM_CLASS (klass),
		              G_SIGNAL_RUN_LAST,
		              G_STRUCT_OFFSET (KrakenViewClass, begin_file_changes),
		              NULL, NULL,
	...
	signals[BEGIN_LOADING] =
		g_signal_new ("begin_loading",
		              G_TYPE_FROM_CLASS (klass),
		              G_SIGNAL_RUN_LAST,
		              G_STRUCT_OFFSET (KrakenViewClass, begin_loading),
		              NULL, NULL,
		              g_cclosure_marshal_VOID__VOID,
		              G_TYPE_NONE, 0);
	signals[CLEAR] =
		g_signal_new ("clear",
		              G_TYPE_FROM_CLASS (klass),
		              G_SIGNAL_RUN_LAST,
		              G_STRUCT_OFFSET (KrakenViewClass, clear),
		              NULL, NULL,
		              g_cclosure_marshal_VOID__VOID,
		              G_TYPE_NONE, 0);
	signals[END_FILE_CHANGES] =
		g_signal_new ("end_file_changes",
		              G_TYPE_FROM_CLASS (klass),
		              G_SIGNAL_RUN_LAST,
		              G_STRUCT_OFFSET (KrakenViewClass, end_file_changes),
		              NULL, NULL,
		              g_cclosure_marshal_VOID__VOID,
		              G_TYPE_NONE, 0);
	signals[END_LOADING] =
		g_signal_new ("end_loading",
		              G_TYPE_FROM_CLASS (klass),
		              G_SIGNAL_RUN_LAST,
		              G_STRUCT_OFFSET (KrakenViewClass, end_loading),
		              NULL, NULL,
	...
	signals[FILE_CHANGED] =
		g_signal_new ("file_changed",
		              G_TYPE_FROM_CLASS (klass),
		              G_SIGNAL_RUN_LAST,
		              G_STRUCT_OFFSET (KrakenViewClass, file_changed),
		              NULL, NULL,
		              g_cclosure_marshal_generic,
		              G_TYPE_NONE, 2, KRAKEN_TYPE_FILE, KRAKEN_TYPE_DIRECTORY);
	signals[LOAD_ERROR] =
		g_signal_new ("load_error",
		              G_TYPE_FROM_CLASS (klass),
		              G_SIGNAL_RUN_LAST,
		              G_STRUCT_OFFSET (KrakenViewClass, load_error),
		              NULL, NULL,
	...
	signals[REMOVE_FILE] =
		g_signal_new ("remove_file",
		              G_TYPE_FROM_CLASS (klass),
		              G_SIGNAL_RUN_LAST,
		              G_STRUCT_OFFSET (KrakenViewClass, remove_file),
		              NULL, NULL,
		              g_cclosure_marshal_generic,
		              G_TYPE_NONE, 2, KRAKEN_TYPE_FILE, KRAKEN_TYPE_DIRECTORY);
	...
	signals[TRASH] =
		g_signal_new ("trash",
			      ...
			      G_STRUCT_OFFSET (KrakenViewClass, trash),
	...
	signals[DELETE] =
		g_signal_new ("delete",
			      G_TYPE_FROM_CLASS (klass),
			      G_SIGNAL_RUN_LAST | G_SIGNAL_ACTION,
			      G_STRUCT_OFFSET (KrakenViewClass, delete),
			      g_signal_accumulator_true_handled, NULL,
			      g_cclosure_marshal_generic,
			      G_TYPE_BOOLEAN, 0);
